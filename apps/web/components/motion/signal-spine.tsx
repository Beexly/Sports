    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background:
            "linear-gradient(180deg, #C9D4CE 0%, #FF4D2E 60%, #FF7A5C 100%)",
          boxShadow: "0 0 12px rgba(255,77,46,0.4), 0 0 4px rgba(201,212,206,0.6)",
      ...
      <div ref={packetsRef} className="absolute inset-0 overflow-hidden">
        {[0, 1, 2, 3].map((i) => (
          <span
            ...
            style={{
              background: i % 2 === 0 ? "#FF4D2E" : "#C9D4CE",
              boxShadow: `0 0 8px 2px ${i % 2 === 0 ? "rgba(255,77,46,0.6)" : "rgba(201,212,206,0.5)"}`,
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2">
        <svg width="16" height="16" viewBox="0 0 64 64" fill="none" className="opacity-60">
          <path
            ...
            stroke="rgba(255,77,46,0.7)"
            strokeWidth="4"
            strokeLinecap="round"
            fill="none"
          />
          <line x1="10" y1="16" x2="54" y2="50" stroke="rgba(255,77,46,0.7)" strokeWidth="4" strokeLinecap="round" />
          <circle cx="34" cy="30" r="5" fill="#FF4D2E" />
        </svg>
      </div>
    </div>
  );
