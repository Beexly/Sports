    ...
    <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-0 transition-all duration-[2000ms]">
      ...
      {state === "volatile" && (
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 30% 20% at 70% 30%, rgba(255,77,46,0.15), transparent)",
      ...
      <div
        className="absolute inset-0"
        style={{
          background: "radial-gradient(ellipse 50% 40% at 50% 50%, rgba(255,77,46,0.02), transparent)",
