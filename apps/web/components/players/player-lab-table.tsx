...
const TABLE_TOKENS = {
  ...
  dark: {
    ...
    playerPos: "text-ink-400",
    teamChip: "text-ink-300",
    signedNeutral: "text-ink-300",
    protStressLow: "text-ink-400",
    eyebrow: "text-orbital-cyan",
    sectionTitle: "text-white",
    blurb: "text-ink-300",
    footnote: "text-ink-400",
    injuryOther: "border-white/[0.08] text-ink-400",
    dfsAgreeCheck: "border-white/[0.08] text-ink-400",
    rushRead: "text-ink-300",
    consensusRead: "text-ink-300",
  },
} as const;
