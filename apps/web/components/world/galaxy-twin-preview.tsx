    ...
    <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
      ...
      <div className="relative overflow-hidden rounded-ds-lg border border-mineral bg-void">
        ...
        >
          ...
          <path d="M0 18 Q 30 26, 66 21 T 100 16" fill="none" stroke="rgba(255,77,46,0.42)" strokeWidth="0.3" strokeDasharray="2 1.6" className="gw-dash-flow" />
          <path d="M0 36 Q 28 30, 56 38 T 100 34" fill="none" stroke="rgba(255,77,46,0.38)" strokeWidth="0.3" strokeDasharray="2 1.6" className="gw-dash-flow" />
          <path d="M0 54 Q 40 60, 70 52 T 100 56" fill="none" stroke="rgba(60,45,110,0.45)" strokeWidth="0.3" strokeDasharray="2 1.6" className="gw-dash-flow" />
          {/* connection threads between nodes */}
          <path d="M30 15.4 L66 21" stroke="rgba(255,77,46,0.5)" strokeWidth="0.22" fill="none" />
          <path d="M66 21 L56 51.8" stroke="rgba(255,77,46,0.5)" strokeWidth="0.22" fill="none" />
