  ...
  return (
    <div className="surface-card p-5">
      <div className="flex items-center justify-between gap-3">
        ...
        <select value={team} onChange={(e) => setTeam(e.target.value)} aria-label="Team" className="rounded-md border bg-transparent px-2 py-1 text-xs text-white" style={{ borderColor: BRAND_COLORS.steelGray }}>
