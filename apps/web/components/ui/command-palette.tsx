...
const COMMANDS: Command[] = [
  ...
  { label: "Daily Brief", href: "/brief", group: "Intelligence", keywords: "brief today picks summary record" },
  { label: "Picks Board", href: "/picks", group: "Intelligence", keywords: "signals published picks board" },
