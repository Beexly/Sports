...
const DECISIONS: readonly GmDecision[] = [
  { id: "gm-1", week: 1, type: "Draft", decision: "Took Marcus Vale at the 1.04 over the consensus WR", rationale: "Bell-cow volume on a top-5 rushing scheme; positional scarcity at RB1.", infoAtCommit: "Full health, locked starter, no committee reported.", confidence: 78, committedAt: "2024-09-04T22:10:00Z", process: "sound", processReason: "Volume + scarcity read was correct with the info available.", outcome: "hit", outcomeNote: "RB5 through the first quarter of the season." },
  { id: "gm-2", week: 2, type: "Start/Sit", decision: "Benched Julian Roe in a tough shadow matchup", rationale: "Elite shadow corner, low projected target share, rain in the forecast.", infoAtCommit: "Corner confirmed active; weather 70% rain at kickoff.", confidence: 61, committedAt: "2024-09-14T16:40:00Z", process: "sound", processReason: "Matchup + weather both pointed down; defensible given the data.", outcome: "miss", outcomeNote: "Roe broke one long TD anyway. A bad beat, not a bad call." },
  { id: "gm-3", week: 3, type: "Waiver", decision: "Spent 62% FAAB on Tariq Bell after the starter's injury", rationale: "Clear lead-back path; league-winning ceiling if the role holds.", infoAtCommit: "Starter ruled out multi-week by an insider report.", confidence: 71, committedAt: "2024-09-17T13:05:00Z", process: "sound", processReason: "Right price for a confirmed standalone role.", outcome: "hit", outcomeNote: "Immediate RB2 value; the bid was the difference." },
  { id: "gm-4", week: 4, type: "Trade", decision: "Traded a WR2 + bench RB for a fading-name WR1", rationale: "Buying the dip on talent; betting on positive regression.", infoAtCommit: "Underlying targets strong; only the box score was cold.", confidence: 64, committedAt: "2024-09-24T19:30:00Z", process: "sound", processReason: "Bought low on stable underlying usage. Process beat the narrative.", outcome: "hit", outcomeNote: "Regression hit; clear WR1 the rest of the way." },
  { id: "gm-5", week: 5, type: "Start/Sit", decision: "Started a boom/bust WR on a hunch over a steady floor play", rationale: "Felt like his week; wanted the upside.", infoAtCommit: "No usage or matchup edge; pure feel.", confidence: 70, committedAt: "2024-10-02T17:15:00Z", process: "unsound", processReason: "No evidentiary edge; the confidence wasn't earned by the info.", outcome: "hit", outcomeNote: "It paid, but the process was luck, and the ledger says so." },
  { id: "gm-6", week: 6, type: "Waiver", decision: "Chased last week's points, dropping a stash for a one-week spike", rationale: "He went off; grab him before the league does.", infoAtCommit: "Spike was a blowout-script outlier; role unchanged.", confidence: 66, committedAt: "2024-10-08T14:20:00Z", process: "unsound", processReason: "Recency bias: bought a non-repeatable outlier over a real role.", outcome: "miss", outcomeNote: "Back to the bench the next week; the stash broke out elsewhere." },
  { id: "gm-7", week: 7, type: "Start/Sit", decision: "Held a star through a questionable tag instead of pivoting", rationale: "Track record of playing through it; no practice-report red flag.", infoAtCommit: "Full practice Friday; beat writer expected him to play.", confidence: 69, committedAt: "2024-10-16T18:00:00Z", process: "thin", processReason: "Reasonable, but a contingency plan should have been queued.", outcome: "miss", outcomeNote: "Late scratch in warmups: a known tail risk that was under-hedged." },
];
