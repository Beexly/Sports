...
export const FEATURE_GAPS: readonly FeatureGap[] = [
  ...
  { id: "query_builder", feature: "Stathead-style Finder/query-builder over historical data", competitorsWithIt: ["stathead"], gseStatus: "gap", copyability: 0.4, valueToGse: 0.85, trustImpact: 0.6, buildSketch: "Composable filter stacks over our entity graph (player/game/situation) → 'every game where X'. Pairs with evidence engine." },
  ...
  { id: "injury_probability", feature: "Injury miss-time probability model", competitorsWithIt: ["draft_sharks"], gseStatus: "gap", copyability: 0.4, valueToGse: 0.75, trustImpact: 0.4, buildSketch: "Model P(miss time) from injury type/history + position base rates + workload; feed projection variance + falsifiers." },
  { id: "pool_survivor_optimizer", feature: "Survivor / pool pick optimizer", competitorsWithIt: ["teamrankings"], gseStatus: "gap", copyability: 0.5, valueToGse: 0.65, trustImpact: 0.3, buildSketch: "EV-optimal survivor path with future-week equity (save strong teams); a sticky seasonal product with low direct competition." },
