...
export const ANALYTICS_METHODS: readonly AnalyticsMethod[] = [
  ...
  { id: "hier_bayes", name: "Bayesian hierarchical / partial pooling", domain: "projection", summary: "Shrink small samples toward group priors.", gseTranslation: "Stable player projections early in season.", maturity: "partial", difficulty: "hard", outsideOrigin: "multilevel models / epidemiology" },
  ...
  { id: "shrinkage_cov", name: "Ledoit-Wolf shrinkage covariance", domain: "dfs", summary: "Stable correlation estimates from few samples.", gseTranslation: "Better DFS stacking/correlation under small samples.", maturity: "partial", difficulty: "hard", outsideOrigin: "quant finance" },
