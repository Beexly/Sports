...
export const ANALYTICS_METHODS: readonly AnalyticsMethod[] = [
  ...
  { id: "glicko2", name: "Glicko-2 ratings", domain: "rating", summary: "Elo + rating-variance + volatility.", gseTranslation: "Uncertainty-aware power ratings; flags uncertain teams.", maturity: "gap", difficulty: "medium" },
  { id: "dixon_coles", name: "Dixon-Coles", domain: "score_model", summary: "Bivariate-Poisson w/ low-score correction + time decay.", gseTranslation: "Soccer scorelines + correct-score props.", maturity: "gap", difficulty: "hard", outsideOrigin: "Dixon & Coles 1997" },
  ...
  { id: "log_opinion_pool", name: "Log opinion pool ensemble", domain: "ensemble", summary: "Weighted geometric mean of probabilities.", gseTranslation: "Combine model + market + agent verdicts coherently.", maturity: "gap", difficulty: "easy", outsideOrigin: "forecasting / decision theory" },
  { id: "extremize", name: "Extremizing", domain: "ensemble", summary: "Push averaged forecasts away from 0.5 in log-odds.", gseTranslation: "Sharper combined confidence when forecasters are independent.", maturity: "gap", difficulty: "easy", outsideOrigin: "Good Judgment / superforecasting" },
  { id: "isotonic", name: "Isotonic (PAVA) calibration", domain: "calibration", summary: "Monotone map from raw score to empirical rate.", gseTranslation: "Calibrate confidence without assuming a sigmoid.", maturity: "gap", difficulty: "medium", outsideOrigin: "isotonic regression" },
  { id: "platt", name: "Platt / temperature scaling", domain: "calibration", summary: "Logistic / single-temperature recalibration.", gseTranslation: "Lightweight confidence calibration.", maturity: "gap", difficulty: "easy" },
  { id: "conformal", name: "Split-conformal intervals", domain: "uncertainty", summary: "Distribution-free prediction intervals from residual quantiles.", gseTranslation: "Honest projection ranges (safe/balanced/upside).", maturity: "gap", difficulty: "medium", outsideOrigin: "conformal prediction" },
  { id: "crps", name: "CRPS scoring", domain: "calibration", summary: "Proper score for full predictive distributions.", gseTranslation: "Grade projection distributions, not just point error.", maturity: "gap", difficulty: "medium", outsideOrigin: "weather ensemble forecasting" },
  { id: "kalman_form", name: "State-space / Kalman form tracking", domain: "rating", summary: "Latent form as a smoothed evolving state.", gseTranslation: "In-season form that reacts without overreacting.", maturity: "gap", difficulty: "hard", outsideOrigin: "control theory / epi nowcasting" },
  { id: "psi_drift", name: "Population Stability Index", domain: "drift", summary: "Distribution-shift metric between expected and actual.", gseTranslation: "Detect data/feature drift before it corrupts picks.", maturity: "gap", difficulty: "easy", outsideOrigin: "credit risk scoring" },
  { id: "black_litterman", name: "Black-Litterman style blend", domain: "market", summary: "Blend a market-implied prior with model views by confidence.", gseTranslation: "Principled model+market fusion instead of ad-hoc weights.", maturity: "gap", difficulty: "hard", outsideOrigin: "quant portfolio theory" },
  ...
  { id: "risk_parity", name: "Risk-parity exposure", domain: "dfs", summary: "Balance risk contribution across positions.", gseTranslation: "DFS portfolio exposure that isn't concentration in disguise.", maturity: "gap", difficulty: "medium", outsideOrigin: "quant finance" },
  ...
  { id: "thompson", name: "Thompson sampling / bandits", domain: "outside_transfer", summary: "Balance explore/exploit across strategies.", gseTranslation: "Pick which model/strategy to trust as evidence accrues.", maturity: "gap", difficulty: "medium", outsideOrigin: "reinforcement learning" },
