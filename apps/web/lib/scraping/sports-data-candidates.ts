...
export const SPORTS_DATA_CANDIDATES: readonly SportsDataCandidate[] = [
  ...
  // ── Free-data census additions (2026-07-02, handoff/claude/overnight-2026-07-01/FREE-DATA-CENSUS.md) ──
  {
    ...
    notes: "Census priority #2 (after NWS weather, already cleared in the registry). Facts are not copyrightable (Feist); the terms read decides HOW we may fetch them.",
  },
  {
    id: "baseball-savant",
  ...
  },
  {
    ...
    registrySourceId: null,
    verificationSteps: STANDARD_STEPS,
    notes: "Community-maintained DB; useful for logos/venue metadata where licensing of official marks must ALSO be considered (team logos are trademarks; display context matters).",
  },
  {
    ...
    registrySourceId: null,
    verificationSteps: STANDARD_STEPS,
    notes: "MLS is already covered by openfootball (cleared); this adds European leagues if/when GSE expands soccer.",
  },
];
