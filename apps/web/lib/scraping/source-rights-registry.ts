...
export const SOURCE_RIGHTS_REGISTRY: readonly SourceRightsEntry[] = [
  ...
  // ── Approved: public domain government data ──────────────────────────────────
  {
    source_id: "openweather-nws",
    ...
    evidence_urls: ["https://www.weather.gov/disclaimer", "https://www.data.gov/open-government-policy/"],
    unlock_condition: null,
    vendor_contact: null,
    notes: "US government data. Public domain by law (17 U.S.C. §105). No restriction on commercial use, attribution, or storage.",
  },

  // ── Approved: platform-internal signals ──────────────────────────────────────
  {
    source_id: "platform-internal",
    source_name: "Beexly Sports Platform (internal)",
    source_url: "https://beexly.com",
    terms_url: null,
    robots_url: null,
    jurisdiction: "US",
    source_type: "other",
    ...
    unlock_condition: null,
    vendor_contact: null,
    notes: "Platform-generated derived signals (schedule density, computed form metrics). First-party data with full rights.",
  },
