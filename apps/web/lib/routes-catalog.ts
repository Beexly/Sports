...
export const ROUTES: ReadonlyArray<RouteEntry> = [
  ...
  // ── Personal surfaces ─────────────────────────────────────────
  {
    path: "/briefing",
    label: "My Briefing",
    mobileLabel: "Personal Briefing",
    state: "live",
    priority: 0.8,
    changeFrequency: "daily",
    inDesktopNav: false,
    inMobileNav: true,
    summary: "Daily personalized intelligence briefing — what changed, what matters, what to ignore.",
  },
  {
    path: "/no-bet",
    label: "No-Bet",
    mobileLabel: "No-Bet Engine",
    state: "live",
    priority: 0.7,
    changeFrequency: "daily",
    inMobileNav: true,
    summary: "What the model scored but didn't publish — and why passing is a valid decision.",
  },
  // ── Sport intelligence pages (SEO) ───────────────────────────
  {
    path: "/nfl",
    label: "NFL",
    mobileLabel: "NFL Intelligence",
    state: "live",
    priority: 0.8,
    changeFrequency: "daily",
    inMobileNav: true,
    summary: "NFL scoring model — rest, schedule density, line movement, ATS form.",
  },
  {
    path: "/nba",
    label: "NBA",
    mobileLabel: "NBA Intelligence",
    state: "live",
    priority: 0.8,
    changeFrequency: "daily",
    inMobileNav: true,
    summary: "NBA scoring model — B2B rest, player usage, pace, travel patterns.",
  },
  {
    path: "/mlb",
    label: "MLB",
    mobileLabel: "MLB Intelligence",
    state: "live",
    priority: 0.8,
    changeFrequency: "daily",
    inMobileNav: true,
    summary: "MLB scoring model — starting pitcher, bullpen usage, park factors, weather.",
  },
  // ── Decision-quality surfaces ─────────────────────────────────
  {
    path: "/parlay-mri",
    label: "Parlay MRI",
    mobileLabel: "Parlay MRI",
    state: "live",
    priority: 0.7,
    changeFrequency: "monthly",
    inMobileNav: true,
    summary: "Parlay correlation, EV dilution, and structural diagnostics. Why most parlay losses aren't bad picks.",
  },
  {
    path: "/market-mirage",
    label: "Market Mirage",
    mobileLabel: "Market Mirage Detector",
    state: "live",
    priority: 0.7,
    changeFrequency: "monthly",
    inMobileNav: true,
    summary: "Six false-signal patterns the market produces and how Galaxy screens them from real movement.",
  },
  {
    path: "/roster-shock",
    label: "Roster Shock",
    mobileLabel: "Roster Shock Index",
    state: "live",
    priority: 0.7,
    changeFrequency: "weekly",
    inMobileNav: true,
    summary: "How lineup changes reprice the market and where the timing window for value sits.",
  },
  {
    path: "/coaching-edge",
    label: "Coaching Edge",
    mobileLabel: "Coaching Edge Model",
    state: "live",
    priority: 0.7,
    changeFrequency: "monthly",
    inMobileNav: true,
    summary: "Five coaching factors with measurable ATS implications. The most stable signal in a variable game.",
  },
  {
    path: "/profile",
    label: "Betting Brain",
    mobileLabel: "Betting Brain Profile",
    state: "live",
    priority: 0.6,
    changeFrequency: "monthly",
    inMobileNav: true,
    summary: "Self-assessment across five dimensions. Shapes how Galaxy frames your briefing, alerts, and risk.",
  },
  {
    path: "/autopsy",
    label: "Autopsy",
    mobileLabel: "Post-Bet Autopsy",
    state: "live",
    priority: 0.7,
    changeFrequency: "daily",
    inMobileNav: true,
    summary: "Four-dimensional pick review: process, signal, CLV, outcome. Separates variance from real failure.",
  },
