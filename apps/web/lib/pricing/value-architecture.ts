...
export const VALUE_TIERS: readonly ValueTier[] = [
  ...
  },
  {
    ...
    unlocks: [
      ...
      "Honesty surfaces: No-Bet detail, interval ranges, glass ledger, recompute",
    ],
    gated: [
    ...
    whyNextTier:
      "Elite adds graded-pick alerts and the line-value tracker: email and push when a followed pick grades — the alert carries the settled result, never a prediction — plus the closing-line-value tracker that grades every entry price. You act sooner and see whether the timing paid.",
  },
  {
    id: "ELITE",
    name: "Galaxy IQ",
    order: 2,
    promise: "Act sooner, and see whether the timing paid.",
    forWho: "Bettors who want alerts on settled picks and a private tracker that grades every entry price.",
    status: "live",
    ctaLabel: "Go Elite",
    price: { monthly: founding.elite.monthly, annual: founding.elite.annual, note: "founding rate, locked for life" },
    unlocks: [
      "Everything in Pro",
      "Graded-pick alerts: email and push when a followed pick settles (never a prediction)",
      "Line-value tracker: your private bet log, graded against the close",
      "Staking calculator: Kelly-aware sizing on the tracker",
      "Deeper market-movement context",
      "Advanced filters and saved watchlists",
      "Calibration reports: how confidence has matched real outcomes",
      "First access to new intelligence surfaces",
    ],
    gated: [
