...
export const VALUE_TIERS: readonly ValueTier[] = [
  {
    ...
    unlocks: [
      ...
      "The Edge Index on every free pick (the Pro strength score is explicitly not a win probability)",
  ...
  },
  {
    ...
    unlocks: [
      ...
      "Signal-rank audits, with probability reliability shown only when frozen probabilities exist",
