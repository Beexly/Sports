...
export const VALUE_TIERS: readonly ValueTier[] = [
  {
    ...
    unlocks: [
      ...
      "Every pick, free - no daily limit, with the open, honest verified record",
      "The full board, free - confidence, factor trail, line movement, and tools are the paid line",
    ...
    whyNextTier:
      "Pro opens today's full board and the reasoning behind every signal — the daily product, not the preview.",
  },
  {
    id: "PRO",
    name: "Edge Board",
