...
export const AGENT_OS_REGISTRY = [
  ...
  agent("delta", "Delta", "Sports Intelligence", "Market / Line Intelligence Analyst", "DRAFT_ONLY", "SPECIALIST", "DRAFT", draftActions, ["Market Twin"], ["line-movement", "clv-candidate"], "Surface free Gamma + methodTag continuous CLV archive internally; no public CLV leaderboard until Neon-proven."),
  ...
  agent("chain", "Chain", "Data & Automation Platform", "Workflow Automation Coordinator", "DRAFT_ONLY", "SPECIALIST", "DRAFT", draftActions, ["Tasks"], ["workflow-routing"], "Draft-governed workflow routing; no external publish/send."),
  ...
  agent("gauge", "Gauge", "Customer Surface & Quality", "Quality Assurance Department Head", "DRAFT_ONLY", "DEPARTMENT_HEAD", "DRAFT", draftActions, ["Review"], ["claim-check", "defect-review"], "Draft claim/quality reviews; never publish performance claims."),
  agent("quill", "Quill", "Customer Surface & Quality", "Brand Voice & Humanizer", "DRAFT_ONLY", "SPECIALIST", "DRAFT", draftActions, ["Media"], ["voice-pass"], "Draft voice passes on AVA content; never publish."),
  ...
  agent("flare", "Flare", "Growth, Community & Finance", "Marketing & Customer Sourcing Head", "DRAFT_ONLY", "DEPARTMENT_HEAD", "DRAFT", draftActions, ["Bot Outbox", "Promo Desk"], ["campaign-draft"], "Draft campaigns only; no external sends."),
  agent("pulse", "Pulse", "Growth, Community & Finance", "Community & Engagement Head", "DRAFT_ONLY", "DEPARTMENT_HEAD", "DRAFT", draftActions, ["Moderation"], ["community-health", "friction-signal"], "Draft engagement/moderation tasks; no auto-mod external."),
  agent("vector", "Vector", "Growth, Community & Finance", "Analytics, Forecasting & Planning Head", "DRAFT_ONLY", "DEPARTMENT_HEAD", "DRAFT", draftActions, ["Dashboard"], ["roadmap-forecast"], "Draft forecasts from real data only; unknown stays unknown."),
  agent("mint", "Mint", "Growth, Community & Finance", "Financials Department Head", "DRAFT_ONLY", "DEPARTMENT_HEAD", "DRAFT", draftActions, ["API Costs"], ["finance-summary"], "Draft finance summaries from real Stripe/cost inputs only."),
  agent("ledger", "Ledger", "Results & Calibration", "Settlement & Results Officer", "DRAFT_ONLY", "SPECIALIST", "DRAFT", draftActions, ["History", "Losses"], ["settlement-review", "canonical-ledger"], "Draft settlement reviews; free settle path exists; public ledger gated."),
