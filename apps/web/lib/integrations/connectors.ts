...
export const CONNECTORS: readonly Connector[] = [
  {
    ...
    path: null,
    why: "Sleeper publishes a documented, public read API for third-party apps. We only ever GET. We never write, post, or change anything in your league.",
  },
  {
  ...
  },
  {
    ...
    path: "Salaries activate when the licensed DFS provider key is set (SportsDataIO / FantasyData). Direct lineup import is not offered; there is no permitted API.",
