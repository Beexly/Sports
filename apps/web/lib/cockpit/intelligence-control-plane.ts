/**
 * Founder-only intelligence control-plane view models.
 *
 * Derives source health, domain coverage, fallback chains, and trace summaries
 * for cockpit review without exposing the proprietary scoring method publicly.
 */
import {
