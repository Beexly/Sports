/**
 * Product / business analytics toolkit barrel — namespaced re-exports of every
 * pure library in this directory. Part of the Galaxy Sports Edge cohesive analytics layer.
 *
 * Usage: import { abTesting } from '@/lib/analytics';
 *
 * 30 modules. Namespaced (export * as) so identically-named helpers
...
export * as eventAnalytics from './event-analytics';
export * as events from './events';
export * as forecastingAnalytics from './forecasting-analytics';
...
export * as riskAnalytics from './risk-analytics';
