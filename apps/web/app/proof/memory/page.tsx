...
export const metadata: Metadata = {
  title: "What we learned — the scar memory",
  description: "The traps we're avoiding and the losses we didn't overreact to. A lab notebook, not a highlight reel.",
};

/**
 * Memory — the public face of the organism's scar memory + process-over-outcome discipline. A settled
 * trap becomes a ghost that suppresses its twin next time; a sound call that loses to variance teaches
 * NOTHING (one week never moves a weight). Built from the loop fixtures; clearly illustrative.
 */
    ...
    <>
      ...
      <main className="container flex flex-col gap-14 py-12">
        <header className="max-w-2xl">
          ...
          <h1 className="mt-2 text-3xl font-semibold text-ion-white">We remember our scars.</h1>
        ...
        <section className="flex flex-col gap-4">
          ...
          <article className="surface-card flex flex-col gap-2 p-5">
            <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-plasma">Scar logged</p>
