/**
 * Route-level loading fallback for the Pick Analytics workbench.
 *
 ...
 * metric grid + section cards) rather than a full-screen layout. Purely
 ...
 */
export default function PickAnalyticsLoading(): JSX.Element {
  return (
    <div
      className="flex flex-col gap-6"
      role="status"
      aria-busy="true"
      aria-label="Loading the Pick Analytics workbench"
    >
      <span className="sr-only">Loading the Pick Analytics workbench…</span>

      {/* Header skeleton */}
      <div className="flex flex-col gap-3" aria-hidden>
        <div className="h-3 w-48 animate-pulse rounded bg-white/[0.06]" />
        <div className="h-7 w-72 animate-pulse rounded-lg bg-white/[0.08]" />
