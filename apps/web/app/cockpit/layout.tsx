  ...
  if (session.user.role !== "ADMIN") {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-obsidian/60 px-6 text-center">
        <p className="rounded-md bg-caution/10 px-3 py-1 font-mono text-label font-bold uppercase tracking-widest text-caution">
      ...
      <header className="border-b border-titanium/40 bg-obsidian/90 backdrop-blur-sm">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            <span
              className="rounded-md bg-caution/10 px-2 py-0.5 text-label font-bold uppercase tracking-widest text-caution"
            ...
            {!adminEmailsConfigured && (
              <span
                className="rounded-md border border-caution-deep/60 bg-caution/10 px-2 py-0.5 text-label font-bold uppercase tracking-widest text-caution-deep"
