    ...
    <div className="flex min-w-[320px] flex-col gap-2">
      <label className="text-[11px] font-semibold text-ink-400">
        ...
        <input
          ...
          className="mt-1 h-11 w-full rounded-md border border-white/[0.06] bg-black/40 px-3 text-xs text-white outline-none focus:border-yellow-500/60"
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="min-h-11 rounded-md border border-yellow-500/40 px-3 text-xs font-semibold text-yellow-100 hover:bg-yellow-950/30 disabled:border-white/[0.06] disabled:text-ink-500"
        >
          Enable 24h
        </button>
        <button
          ...
          disabled={!canSubmit || !overrideActive}
          className="min-h-11 rounded-md border border-white/[0.06] px-3 text-xs font-semibold text-ink-300 hover:bg-white/[0.03] disabled:text-ink-500"
        >
          Disable
        </button>
      </div>
