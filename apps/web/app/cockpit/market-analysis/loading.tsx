/**
 * Route-level loading fallback for the Market Analysis workbench.
 *
 ...
 */
export default function MarketAnalysisLoading(): JSX.Element {
  return (
    <div
      className="flex flex-col gap-6"
      role="status"
      aria-busy="true"
      aria-label="Loading the Market Analysis workbench"
    >
      <span className="sr-only">Loading the Market Analysis workbench…</span>
      ...
      {/* Coverage banner + per-game table skeletons */}
      <div
