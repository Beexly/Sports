  ...
  return (
    <div className="min-h-screen bg-obsidian/60 px-4 py-10 sm:px-6 lg:px-8 text-ion-1">
      <div className="mx-auto max-w-5xl">
        <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-orbital-cyan">Cockpit · Visual Production</p>
        <h1 className="mt-1.5 text-2xl font-bold text-ion-white">Film Room</h1>
        ...
        {/* Master spend gate */}
        <div className={`mt-6 rounded-xl border p-4 text-sm ${masterReady ? "border-caution/50 bg-caution/20" : "border-titanium/40 bg-eclipse/40"}`}>
              ...
              <div key={a.id} className="rounded-xl border border-titanium/40 bg-eclipse/40 p-5">
                <div className="flex flex-wrap items-start justify-between gap-2">
                  ...
                  <div className="text-right">
                    ...
                    <p className={`mt-1 text-[11px] font-semibold ${decision.allowed ? "text-caution" : "text-verify"}`}>
