    ...
    <div className="min-h-screen bg-obsidian">
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        <div className="mb-10 space-y-4">
          ...
          <div className="h-9 w-72 animate-pulse rounded bg-white/[0.08]" />
          <div className="h-4 w-96 animate-pulse rounded bg-white/[0.06]" />
        </div>
        <div className="flex gap-6">
          <div className="flex-1 rounded-xl border border-white/[0.10] bg-white/[0.03] p-6">
            ...
            <div className="space-y-3">
              {[0, 1, 2, 3, 4].map((row) => (
                <div key={row} className="grid grid-cols-5 gap-4 rounded-lg border border-white/[0.10]/30 px-3 py-3">
          ...
          <div className="w-80 rounded-xl border border-white/[0.10] bg-white/[0.03] p-6">
            <div className="mb-5 h-5 w-40 animate-pulse rounded bg-white/[0.08]" />
            ...
            <div className="mt-6 rounded-lg border border-white/[0.06] bg-obsidian/60 p-4">
              <div className="mb-2 h-3.5 w-20 animate-pulse rounded bg-white/[0.05]" />
              <div className="h-8 w-32 animate-pulse rounded bg-white/[0.08]" />
              <div className="mt-2 h-3 w-44 animate-pulse rounded bg-white/[0.04]" />
            </div>
          </div>
        </div>
      </main>
