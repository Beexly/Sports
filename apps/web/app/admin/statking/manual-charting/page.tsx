...
export default async function Page(){
  ...
  <p className="text-ink-300">First-party charting notes with explicit display and model approval flags — the owned signal layer, rights-clean by construction.</p>
