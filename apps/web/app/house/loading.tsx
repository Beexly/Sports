  ...
  return (
    <div className="min-h-screen bg-obsidian">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-10 sm:px-6">
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.08]/5 p-6 sm:p-8">
          ...
          <div className="mt-2 h-4 w-5/6 animate-pulse rounded bg-white/[0.06]" />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-12 sm:px-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="flex flex-col rounded-2xl border border-white/[0.06] bg-white/[0.08]/5 p-5"
            >
              {/* Room name */}
              <div className="h-5 w-36 animate-pulse rounded bg-white/[0.08]" />
              {/* Whose-for text */}
              <div className="mt-2 h-3.5 w-28 animate-pulse rounded bg-white/[0.06]" />
              {/* Promise paragraph */}
              <div className="mt-4 space-y-2 flex-1">
                <div className="h-3.5 w-full animate-pulse rounded bg-white/[0.05]" />
                <div className="h-3.5 w-5/6 animate-pulse rounded bg-white/[0.05]" />
                <div className="h-3.5 w-4/6 animate-pulse rounded bg-white/[0.05]" />
              </div>
              {/* Footer action button */}
              <div className="mt-5 h-9 w-32 animate-pulse rounded-lg bg-white/[0.06]" />
            </div>
          ))}
        </div>
      </section>
