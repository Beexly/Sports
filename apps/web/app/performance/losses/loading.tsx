...
function LossRowSkeleton() {
  return (
    <div className="flex items-start gap-4 rounded-xl border border-white/[0.10] bg-white/[0.08]/5 px-5 py-4">
      {/* Sport indicator / avatar */}
      <div className="mt-0.5 h-10 w-10 flex-shrink-0 animate-pulse rounded-full bg-white/[0.08]" />
  ...
  return (
    <div className="min-h-screen bg-obsidian">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        {/* Heading skeleton */}
        <div className="mb-2 h-8 w-56 animate-pulse rounded bg-white/[0.08]" />
        <div className="mb-8 h-4 w-72 animate-pulse rounded bg-white/[0.06]" />
