    ...
    <div className="min-h-screen bg-carbon text-ion">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
        <PageHero
          ...
          aside={
            view.explainer && view.explainer.length > 0 ? (
              <MetricExplainer variant="dark" terms={view.explainer} />
            ) : undefined
          }
        />
        ...
        <Tabs
          ...
          active={view.slug}
          pathname={PATHNAME}
          // The shared <Tabs> is paper-surface by default (and stays that way for
          // the intelligence boards). The Player Lab is a dark "carbon" surface,
          // so we re-skin it through the className escape hatch only — see the
          // matching DataTable overrides in components/players/player-lab-table.tsx.
          className="!border-mineral !bg-eclipse [&_.bg-paper-raised]:!bg-mineral [&_.text-ink]:!text-ion-white [&_.text-ink-1]:!text-ion-1 [&_a:hover]:!bg-white/5 [&_a:hover]:!text-ion-white"
