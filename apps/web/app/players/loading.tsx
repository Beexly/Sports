  ...
  return (
    <div className="min-h-screen bg-obsidian">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8 pt-14 sm:px-6">
        <div className="mb-3 h-5 w-32 animate-pulse rounded-full bg-white/[0.06]" />
        <div className="mb-3 h-10 w-1/2 animate-pulse rounded-lg bg-white/[0.08]" />
        <div className="mb-1.5 h-4 w-2/5 animate-pulse rounded bg-white/[0.06]" />
        <div className="h-4 w-1/3 animate-pulse rounded bg-white/[0.06]" />
      </section>

      {/* Source status ribbon */}
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-6 flex items-center gap-4 rounded-xl border border-white/[0.10] bg-white/[0.03] px-5 py-3">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6">
        <div className="overflow-hidden rounded-xl border border-white/[0.10] bg-white/[0.03]">
          {/* Table header */}
          <div className="grid grid-cols-[1fr_auto_auto_auto_auto] items-center gap-4 border-b border-white/[0.10] px-5 py-3">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              key={i}
              className="grid grid-cols-[1fr_auto_auto_auto_auto] items-center gap-4 border-b border-white/[0.06] px-5 py-4 last:border-0"
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="h-3 w-1 animate-pulse rounded bg-white/[0.06]" />
