...
const ROUTES: ReadonlyArray<{
  ...
  { path: "/intelligence/observatory", priority: 0.6, changeFrequency: "weekly" },
  { path: "/intelligence/airwave", priority: 0.6, changeFrequency: "weekly" },
  { path: "/intelligence/trends", priority: 0.6, changeFrequency: "weekly" },
  { path: "/intelligence/track", priority: 0.6, changeFrequency: "weekly" },
  { path: "/intelligence/the-beat", priority: 0.6, changeFrequency: "weekly" },
