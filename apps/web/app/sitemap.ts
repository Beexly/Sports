...
const ROUTES: ReadonlyArray<{
  ...
  { path: "/intelligence", priority: 0.9, changeFrequency: "daily" },
  { path: "/methodology", priority: 0.8, changeFrequency: "monthly" },
  { path: "/fantasy", priority: 0.7, changeFrequency: "weekly" },
  { path: "/market-gravity", priority: 0.7, changeFrequency: "weekly" },
  { path: "/brain", priority: 0.7, changeFrequency: "weekly" },
  { path: "/rumor-radar", priority: 0.7, changeFrequency: "weekly" },
