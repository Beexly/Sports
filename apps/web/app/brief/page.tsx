      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        {todayPickCount > 0 && (
          <div
            ...
            className="mt-4 rounded-xl border border-mineral bg-eclipse/40 p-4"
          >
        ...
        {brief.readiness.performance ? (
          <p data-testid="brief-performance-hidden" className="mt-3 text-xs text-ink-400">
            Performance summary will render here once the composer is restored.
          </p>
        ) : (
          <p data-testid="brief-performance-gated" className="mt-3 text-xs text-ink-400">
            Performance data is gated until canonical sample is sufficient.
          </p>
        )}
        <p className="mt-6 rounded-lg border border-mineral bg-eclipse/40 px-4 py-3 text-xs text-ink-300">
