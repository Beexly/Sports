...
/** Client nav chrome for StatKing — only mounted when public gate is open. */
export function StatsNav() {
  return (
    <nav
      aria-label="Stats sections"
      className="border-b border-mineral bg-eclipse/60 sticky top-0 z-20 backdrop-blur-sm"
    >
