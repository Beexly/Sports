  ...
  return (
    <div className="min-h-screen bg-obsidian">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-10 pt-14 sm:px-6">
        <div className="mb-3 h-5 w-36 animate-pulse rounded-full bg-white/[0.06]" />
        <div className="mb-3 h-10 w-2/3 animate-pulse rounded-lg bg-white/[0.08]" />
        <div className="mb-1.5 h-4 w-1/2 animate-pulse rounded bg-white/[0.06]" />
        <div className="h-4 w-5/12 animate-pulse rounded bg-white/[0.06]" />
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6">
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="flex flex-col gap-4 rounded-2xl border border-white/[0.10] bg-white/[0.03] p-5"
            >
              ...
              <div className="space-y-1.5">
                ...
                <div className="h-3.5 w-11/12 animate-pulse rounded bg-white/[0.06]" />
                <div className="h-3.5 w-3/4 animate-pulse rounded bg-white/[0.06]" />
              </div>
              {/* Action button */}
              <div className="mt-auto h-9 w-full animate-pulse rounded-lg bg-white/[0.06]" />
            </div>
          ))}
        </div>
      </section>
