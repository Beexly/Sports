...
function BoardStatSkeleton() {
  return (
    <div className="rounded-xl border border-titanium bg-carbon/60 p-4">
      ...
      <div className="mt-2 h-7 w-16 animate-pulse rounded bg-titanium" />
    </div>
  );
}
...
function PassRowSkeleton() {
  return (
    <div className="flex items-center justify-between gap-4 rounded-lg border border-titanium/40 bg-carbon/40 p-3">
      <div className="flex-1 space-y-1.5">
        <div className="h-4 w-48 animate-pulse rounded bg-titanium/80" />
        <div className="h-3 w-32 animate-pulse rounded bg-titanium/50" />
      </div>
      <div className="flex items-center gap-2">
        <div className="h-5 w-16 animate-pulse rounded-full bg-titanium/60" />
        <div className="h-5 w-12 animate-pulse rounded bg-titanium/40" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative isolate min-h-screen w-full overflow-x-hidden bg-obsidian">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
        <div>
          <div className="h-3 w-20 animate-pulse rounded bg-titanium/60" />
          <div className="mt-2 h-8 w-56 animate-pulse rounded bg-titanium" />
          <div className="mt-2 h-4 w-80 max-w-full animate-pulse rounded bg-titanium/50" />
        </div>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="rounded-2xl border border-titanium bg-carbon/40 p-6">
            <div className="mb-3 h-4 w-28 animate-pulse rounded bg-titanium" />
            <div className="space-y-3">
              {[0, 1, 2].map((i) => (
                <div key={i} className="h-4 animate-pulse rounded bg-titanium/40" style={{ width: `${85 - i * 10}%` }} />
              ))}
            </div>
          </div>
          <div className="rounded-2xl border border-titanium bg-carbon/40 p-6">
            <div className="mb-3 h-4 w-36 animate-pulse rounded bg-titanium" />
