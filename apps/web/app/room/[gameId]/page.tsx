...
import { PressRTheater } from "@/components/factor-audit/PressRTheater";
    ...
    <div className="min-h-screen bg-carbon text-gray-100">
      ...
      <main className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <PressRTheater
          ...
          finalEdgeIndex={room.node.marketPulse.edgeIndex}
          finalConfidence={hasPublishedPick ? evidenceScore : null}
        />
