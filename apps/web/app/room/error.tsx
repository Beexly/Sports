...
/**
 * Game Room segment error boundary.
 *
 * /room/[gameId] is force-dynamic and composes several loaders (entitlements,
 * market pulse, evidence timeline, playback). If anything under /room throws
 * on render, this catches it closer to the surface than the root boundary,
 * keeps the branded chrome, and offers a retry plus a path back to the board.
 */
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-22 sm:px-6 lg:px-8">
        <div className="w-full max-w-xl rounded-2xl border border-alert/30 bg-alert/10 p-8 text-center">
          ...
          <h1 className="text-xl font-bold text-white">
            The game room hit a snag.
          </h1>
          <p className="mt-2 text-sm text-ion-1">
            This page threw a runtime error. Hit retry, or head back to the
            board. The observatory has the trace either way.
          </p>
