...
export default function DfsPage() {
  return (
    <FantasyShell
      ...
      note="Illustrative classic-format salary slate and projections. Salary-cap optimization, stacking, exposure, and leverage are computed live in your browser from the sample pool."
      wide
    >
      <DfsOptimizer />
    </FantasyShell>
