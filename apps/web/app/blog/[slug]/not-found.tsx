      ...
      <main className="flex flex-1 items-center justify-center px-4 py-20">
        <div className="mx-auto max-w-lg text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link href="/blog" className="rounded-xl bg-white/10 px-5 py-2.5 text-sm font-semibold text-white hover:bg-white/15">
              Blog index
            </Link>
            <Link href="/brief" className="rounded-xl border border-gray-700 px-5 py-2.5 text-sm text-gray-300 hover:bg-gray-900">
              Daily Brief
            </Link>
          </div>
        </div>
