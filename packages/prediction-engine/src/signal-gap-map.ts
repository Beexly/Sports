...
export const SIGNAL_GAP_MAP: readonly SignalGapEntry[] = [
  ...
  },
  {
    ...
    flag: null,
    reason:
      "packages/prediction-engine/src/frontier-signal-catalog.ts does NOT exist on origin/main (this worktree). It exists only on the sibling wire-port-contract branch (C:/Users/Garrett/Sports, cursor/wire-port-contract-79e9) where strength.opp_adj_epa is catalogued at that file's line 63. Do not restating the catalog here; track the import until that branch lands. Adjacent implemented module: signals/opponent-adjusted-epa.ts.",
    dataPath: "PARTIAL",
  },
];
