...
function gradeHistoricalClv(
  ...
  if (pick.pickType === "SPREAD") {
    // Boundary-aware, most-specific side derivation — the bare startsWith
    // here was the same LA/LAC-class pattern settlement already fixed. The
    // CLV value is 0 by construction either way; the side is kept honest.
