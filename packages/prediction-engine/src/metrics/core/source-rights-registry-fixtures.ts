...
export const GSE_METRIC_SOURCE_RIGHTS_REGISTRY_FIXTURES = [
  ...
  },
  {
    ...
    model_training_allowed: false,
    notes: "Forbidden pick'em platform; no extraction, storage, display, modeling, or derived analytics.",
  ...
  },
  {
    ...
    model_training_allowed: false,
    notes: "Forbidden fantasy platform; no extraction, storage, display, modeling, or derived analytics.",
    source_id: "underdog",
  ...
  },
  {
    ...
    model_training_allowed: false,
    notes: "Forbidden fantasy network; no extraction, storage, display, modeling, or derived analytics.",
    source_id: "dknetwork",
    source_name: "DraftKings Network",
    status: "permission_required",
    storage_allowed: false,
  },
  {
