...
export const HISTORICAL_DISTRIBUTION_ADAPTER_FIXTURES: readonly HistoricalDistributionRecord[] = [
  ...
  {
    baselineScore: 28,
    description: "Rights-cleared conformal-width rollup can adapt into local CUW distribution review.",
    input: {
      driftPressure: 34,
      expectedWidth: 0.12,
      intervals: [
        { covered: true, lower: 0.18, upper: 0.36 },
        { covered: true, lower: 0.24, upper: 0.44 },
        { covered: true, lower: 0.31, upper: 0.55 },
        { covered: false, lower: 0.4, upper: 0.65 },
        { covered: true, lower: 0.47, upper: 0.75 },
        { covered: true, lower: 0.52, upper: 0.82 },
        { covered: false, lower: 0.58, upper: 1 },
        { covered: true, lower: 0.64, upper: 0.77 },
      ],
      minimumSampleSize: 4,
      reportAgeDays: 2,
      reportFreshnessTtlDays: 14,
    ...
    severeDelta: 28,
    sourceIds: ["nflverse"],
    splitId: "historical_cuw_width_watch",
    watchDelta: 8,
  },
  {
    baselineScore: 82,
  ...
  {
    baselineScore: 30,
    description: "Raw conformal input leakage blocks even when source rights are otherwise cleared.",
    input: {
      driftPressure: 28,
      expectedWidth: 0.12,
      intervals: [
        { covered: true, lower: 0.2, upper: 0.36 },
        { covered: true, lower: 0.27, upper: 0.46 },
        { covered: false, lower: 0.35, upper: 0.62 },
        { covered: true, lower: 0.42, upper: 0.72 },
      ],
      minimumSampleSize: 4,
      reportAgeDays: 1,
      reportFreshnessTtlDays: 14,
    ...
    severeDelta: 28,
    sourceIds: ["nflverse"],
    splitId: "historical_cuw_raw_payload_blocked",
    watchDelta: 8,
  },
  {
    baselineScore: 60,
