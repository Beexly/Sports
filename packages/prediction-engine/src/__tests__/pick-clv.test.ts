...
describe("computePickClv", () => {
  it("SPREAD home pick beats the close on a more generous line", () => {
    // Picked 'Chiefs -3' (home -3), market closed -4 â†’ laid fewer points â†’ +1.
  ...
  it("SPREAD away pick is the mirror of the home line", () => {
    // Picked the away team; home line +2 at lock, closed +4 â†’ away laid fewer â†’ +2.
  ...
  it("TOTAL over beats the close on a lower number", () => {
    // OVER 48 at lock, closed 49 â†’ over needed fewer points â†’ +1.
  ...
  it("MONEYLINE beats the close when locked at a longer price", () => {
    // +150 at lock, closed +120 â†’ longer price than the close â†’ positive CLV.
