 ...
 *
 * Pure â€” no DB, no side effects, fully unit-testable. Persisting CLV per pick
 ...
 *   MONEYLINE â€” pass the bettor's locked American price as `pickLine` and the
 ...
 *                   pick; starts with "OVER"/"UNDER" for totals) â€” the same
