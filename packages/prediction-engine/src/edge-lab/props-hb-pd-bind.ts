...
export function bindPdSamples(
  ...
  for (const req of requests) {
    ...
    // Read pdRate directly from the single prior row; fail-closed on
    // null/undefined/non-finite (the field is optional on main's CovariateRow —
    // absent means unknown, and unknown is refused, never imputed).
