...
function row(overrides: Partial<TprRow> & { playerId: string; week: number; season: number; targets: number; routes: number }): TprRow {
  return { playerId: "SYNTH-001", season: 2024, week: 1, ...overrides } as TprRow;
}
