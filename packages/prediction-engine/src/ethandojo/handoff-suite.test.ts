/**
 * Composition test â€” proves every build in the ethandojo handoff is reachable
...
// â”€â”€â”€ Injectable salary adapter fixture â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
describe("ethandojo handoff composition â€” registry", () => {
...
// â”€â”€â”€ Per-build reachability â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

describe("ethandojo handoff composition â€” every build is reachable", () => {
  it("Build 1: gamePredictor produces documented shape or fail-closed null", () => {
    ...
    // Fail-closed: missing features â†’ null, never a guess
  ...
  it("Build 2: highlightDetector present through canonical film path", () => {
    ...
    // Fail-closed: no backend â†’ clear failure, never fabricated highlights
  ...
  it("Build 3: coverageAnalyzer present through canonical film path", () => {
    ...
    // API surface: analyzePlay (async) + aggregate (async) â€” fail-closed via FilmBackendUnavailableError
  ...
  it("Build 5: fourthDown grades plays", () => {
    ...
    // Fail-closed: invalid probabilities â†’ null
    const result = suite.fourthDown.grade({
      wpGo: 0.52,
      wpActual: 0.48,
    });
    // Either a grade or null â€” never a fabricated grade
    if (result !== null) {
  ...
  it("Build 6: tradeAnalyzer produces verdict", () => {
    ...
    expect(typeof suite.tradeAnalyzer.analyze).toBe("function");
  });
  ...
  it("Build 8: filmSplitter present through canonical film path", () => {
    ...
    expect(typeof suite.filmSplitter.splitPlays).toBe("function");
  });
  ...
  it("Build 10: draftCopilot recommends picks", () => {
    ...
    expect(typeof suite.draftCopilot.recommendPick).toBe("function");
  });
});

// â”€â”€â”€ Salary adapter contract â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

describe("ethandojo handoff composition â€” salary adapter contract", () => {
...
// â”€â”€â”€ Fail if any build is omitted â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

describe("ethandojo handoff composition â€” completeness gate", () => {
