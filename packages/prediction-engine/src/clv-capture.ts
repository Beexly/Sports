 ...
 * (capturedAt null) when no odds were recorded before kickoff, or when the
 * newest eligible batch is older than `maxCloseAgeMs` (a dead feed, not a
 * close) — in which case we cannot honestly grade CLV.
 */
