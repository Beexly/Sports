/**
 * Tests for ./2106-11397v1-props-dfs (arXiv:2106.11397v1, lane=props_dfs).
 *
...
import * as mod from "./2106-11397v1-props-dfs";

describe("props/DFS primitives (arXiv:2106.11397v1)", () => {
  const players = [
