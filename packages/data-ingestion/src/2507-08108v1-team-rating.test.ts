/**
 * Tests for ./2507-08108v1-team-rating (arXiv:2507.08108v1, lane=team_ratings).
 *
 * ACCEPTANCE GATE: Adopt L_alpha-Mallows if on the 2025 held-out season it beats both baselines by >=2pp on pairwise accuracy AND >=5pp on top-5 hit rate in at least 3 of 4 seasons rolling; REJECT if alpha estimates are unstable.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2507-08108v1-team-rating";

describe("2507-08108v1 Mallows Model with Learned Distance Metrics:", () => {
