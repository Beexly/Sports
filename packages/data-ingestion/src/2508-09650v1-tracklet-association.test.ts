/**
 * Tests for ./2508-09650v1-tracklet-association (arXiv:2508.09650v1, lane=tracking).
 *
 * ACCEPTANCE GATE: Adopt the WBCE + occlusion-augmentation recipe if a GSE tracking trainer's fully-occluded-frame RMSE improves by >=15% over the unweighted-loss control on a held-out NFL broadcast clip set with synthetic occlusion labels, with no regression on fully-visible frames.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2508-09650v1-tracklet-association";

describe("2508-09650v1 TOTNet: Occlusion-Aware Temporal Tracking for Robust", () => {
