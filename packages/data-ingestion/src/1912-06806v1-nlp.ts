 ...
 *
 * arXiv:1912.06806v1 · lane:nlp · verdict:ADAPT · owner:Motif-lab
 *
 ...
 *
 * Improvement (wiring record): Adopt the annotation protocol as GSE's standard sports-text benchmark: 5 annotators per item,
 * majority-label adjudication, the (F_pos+F_neg)/2 metric for bullish/bearish/neutral player-news
 * classification, phrase-vs-message subtasks; evaluate zero-shot LLMs and the 1106 lexicon-CNN against
 * it.
 *
...
export const ARXIV_ID = "1912.06806v1" as const;
export const LANE = "nlp" as const;

/** Numeric acceptance gate, verbatim from the wiring record (evaluated offline on backtest data). */
export const ACCEPTANCE_GATE = `ADOPT the protocol as GSE's standard sports-text benchmark if inter-annotator agreement (Fleiss kappa) reaches >=0.6 on a 200-item pilot; REJECT the protocol if kappa < 0.4 (task too subjective for sports text).`;
