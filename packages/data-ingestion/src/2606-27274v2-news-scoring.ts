 ...
 *
 * arXiv:2606.27274v2 · lane:nlp · verdict:ADAPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * Deploy a compliance filter on GSE's affiliate promo copy, sportsbook ad creatives, and sponsored content: sample 500-1,000 promos, triple-annotate with the paper's 3-class taxonomy (Cohen's kappa reported), fine-tune ELECTRA (5 epochs, AdamW, lr 2e-5, inverse-frequency weighted CE) to flag manipulative/deceptive patterns for human review before publication.
 *
 * ACCEPTANCE GATE:
 * Adopt if macro-F1 ≥ 0.65 on triple-annotated held-out promos with annotator κ ≥ 0.6 AND deceptive-class F1 ≥ 0.60 (the paper's 0.511 is the bar to clear).
 *
...
export const ARXIV_ID = "2606.27274v2" as const;
...
export const ACCEPTANCE_GATE = `Adopt if macro-F1 ≥ 0.65 on triple-annotated held-out promos with annotator κ ≥ 0.6 AND deceptive-class F1 ≥ 0.60 (the paper's 0.511 is the bar to clear).`;
