 ...
 *
 * arXiv:2607.19783v2 · lane:team_ratings · verdict:ADAPT · owner:Mimo · doctrine:PROPRIETARY_EDGE
 *
...
export const ARXIV_ID = "2607.19783v2" as const;
...
export const ACCEPTANCE_GATE = `ADOPT the case-crossover module if: (a) the placebo battery shows the naive before/after estimator has mean-reversion bias >=0.05 EPA/drive while the case-crossover bias is <0.02 EPA/drive; AND (b) at least one stoppage-type ATT has |effect| >=0.05 EPA/drive with cluster-robust 95% CI excluding zero. REJECT if stoppages are too rare (<40 events) for stable inference.`;
