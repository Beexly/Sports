/**
 * Tests for ./2606-13033v3-tracklet-association (arXiv:2606.13033v3, lane=tracking).
 *
 * ACCEPTANCE GATE: ADAPT the dispatch + gated-correction design if, on the NFL annotation set, adding margin-dispatched VOS improves AssA by ≥ 3.0 points over the base tracker with the same detections, and false-positive SWAPs stay below 10% of SWAP windows.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2606-13033v3-tracklet-association";

describe("2606-13033v3 Selective Mask Propagation for Multi-Object Tracking", () => {
