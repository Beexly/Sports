/**
 * Tests for ./2607-15483v1-team-rating (arXiv:2607.15483v1, lane=team_ratings).
 *
 * ACCEPTANCE GATE: ADAPT into the EV pipeline if: (a) fitted gamma < 1 with 95% CI excluding 1 on the training window AND (b) the CPT-adjusted edge selector beats the naive edge selector by >=2pp ROI on the 2024-2025 holdout. REJECT if gamma ~= 1 or the CPT adjustment adds no ROI — the distortion must be measured, never assumed.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2607-15483v1-team-rating";

describe("2607-15483v1 Risk-Aware Preference Learning for Stochastic Outcomes", () => {
