 ...
 *
 * arXiv:2508.04008v1 · lane:win_spread_total · verdict:ADAPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * GSE ships game-script-adjusted efficiency metrics: GAMs on EPA/play and count stats projected onto a neutral script (score differential, time, pre-game spread controlled), so 'good teams trailing' aren't misread as 'bad offenses'.
 *
 * ACCEPTANCE GATE:
 * ADOPT if adjusted stats correlate >=0.03 better with season point differential than raw stats AND beat raw stats in LOSOCV margin forecasting at p<0.05.
 *
...
export const ARXIV_ID = "2508.04008v1" as const;
...
export const ACCEPTANCE_GATE = `ADOPT if adjusted stats correlate >=0.03 better with season point differential than raw stats AND beat raw stats in LOSOCV margin forecasting at p<0.05.`;
