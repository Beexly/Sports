 ...
 *
 * arXiv:2602.15673v1 · lane:tracking · verdict:ADAPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * GSE builds an underlying-performance season simulator that prices playoff probability from early-season EPA-rate strengths with shrinkage toward market-implied priors, replacing flat-preseason-Elo postseason forecasts.
 *
 * ACCEPTANCE GATE:
 * Adopt if on 2020-2025 weeks-1-8 inputs the simulator's P(playoff) Brier score beats the flat-preseason-Elo baseline by >=5% relative improvement in at least 4 of 6 seasons, with no season worse than baseline.
 *
...
export const ARXIV_ID = "2602.15673v1" as const;
...
export const ACCEPTANCE_GATE = `Adopt if on 2020-2025 weeks-1-8 inputs the simulator's P(playoff) Brier score beats the flat-preseason-Elo baseline by >=5% relative improvement in at least 4 of 6 seasons, with no season worse than baseline.`;
