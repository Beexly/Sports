/**
 * Tests for ./2601-11492v2-score-model (arXiv:2601.11492v2, lane=win_spread_total).
 *
 * ACCEPTANCE GATE: ADOPT if the fused model beats the Elo/spread baseline by >=3pp cover accuracy on 2023-2024 AND realized top-gradient levers show a statistically significant cover-rate advantage (p<0.05) over non-realized games.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2601-11492v2-score-model";

describe("2601-11492v2 BoxMind: Closed-loop AI strategy optimization for", () => {
