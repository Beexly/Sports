 ...
 *
 * arXiv:2608.27362v1 · lane:team_ratings · verdict:ADAPT · owner:Mimo · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * ACCEPTANCE GATE:
 * Accept the module if on 2000-2025 NFL: (i) out-of-sample (even seasons) Brier <= static BT/Elo baseline after Platt calibration; (ii) calibration slope within [0.9, 1.1] post-fit; (iii) component correlation rho-hat significantly > 0 by prequential likelihood; reject the dynamical component if tau-hat is unidentified or the iterated filter underperforms single-step on simulated recovery.
 *
...
export const ARXIV_ID = "2608.27362v1" as const;
...
export const ACCEPTANCE_GATE = `Accept the module if on 2000-2025 NFL: (i) out-of-sample (even seasons) Brier <= static BT/Elo baseline after Platt calibration; (ii) calibration slope within [0.9, 1.1] post-fit; (iii) component correlation rho-hat significantly > 0 by prequential likelihood; reject the dynamical component if tau-hat is unidentified or the iterated filter underperforms single-step on simulated recovery.`;
