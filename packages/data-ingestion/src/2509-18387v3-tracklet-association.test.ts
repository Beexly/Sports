/**
 * Tests for ./2509-18387v3-tracklet-association (arXiv:2509.18387v3, lane=tracking).
 *
 * ACCEPTANCE GATE: Adopt the blur-label schema if the blur-aware detector beats the center-point baseline by >=2 F1 points on the NFL test set AND position+blur trajectory fitting reduces catch-point MAE vs NGS ground truth by >=25% relative to position-only.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2509-18387v3-tracklet-association";

describe("2509-18387v3 BlurBall: Joint Ball and Motion Blur", () => {
