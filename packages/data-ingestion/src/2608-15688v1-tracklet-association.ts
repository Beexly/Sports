 ...
 *
 * arXiv:2608.15688v1 · lane:tracking · verdict:ADOPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * Clone the McByte++ training-free long-term tracking stack and run it on a sample of NFL broadcast/All-22 plays (football-tuned detector boxes) as the ingestion front end for broadcast-derived tracking, feeding tracklets into GSE's content overlays and the STRAIN pressure / SAIL-for-NFL analytics lanes where NGS tracking is unavailable.
 *
 * ACCEPTANCE GATE:
...
export const ARXIV_ID = "2608.15688v1" as const;
...
export const ACCEPTANCE_GATE = `ADOPT for the content/analytics pipeline if McByte++ reduces ID switches vs ByteTrack by >=40% at >=8 FPS on the 50-play set; REJECT if IDF1 is within 5 points of ByteTrack (no meaningful long-term gain) or FPS < 5 on available hardware.`;
