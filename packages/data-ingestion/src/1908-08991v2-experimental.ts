 ...
 *
 * arXiv:1908.08991v2 · lane:experimental · verdict:ADAPT · owner:Motif-lab
 *
 ...
 *
 * Improvement (wiring record): Build a network-centrality team-strength rating (directed loser->winner graph per season window,
 * edges weighted by margin/EPA, eigenvector centrality) as a benchmark feature against Elo/nfelo on
 * 2002-2025, plus a per-season NFL predictability/Gini monitor and a rolling home-advantage trend
 * refit.
 *
...
export const ARXIV_ID = "1908.08991v2" as const;
export const LANE = "experimental" as const;

/** Numeric acceptance gate, verbatim from the wiring record (evaluated offline on backtest data). */
export const ACCEPTANCE_GATE = `Adopt the centrality rating as a permanent benchmark feature if it beats the repo's Elo baseline on AUC in >=55% of seasons 2002-2025 with lower or equal log-loss; reject as redundant if it underperforms Elo in >50% of seasons.`;
