 ...
 *
 * arXiv:2509.22683 · lane:causal_injury · verdict:ADAPT · owner:Motif-lab · doctrine:SITUATIONAL
 *
 ...
 *
 * Improvement (record):
 * GSE builds a coaching-decision analytics module: per-game NFL coaching aggressiveness indices (early-down pass rate vs expectation, 4th-down go-rate vs WP model, blitz rate) with triple-outcome panel econometrics and exhaustive model averaging.
 *
 * ACCEPTANCE GATE:
 * Accepted: real hand-built dataset, fully specified triple-model econometrics, exhaustive model averaging (393/317/107 specs), bootstrap-validated inference with strong stable headline effects.
 *
...
export const ARXIV_ID = "2509.22683" as const;
...
export const ACCEPTANCE_GATE = `Accepted: real hand-built dataset, fully specified triple-model econometrics, exhaustive model averaging (393/317/107 specs), bootstrap-validated inference with strong stable headline effects.`;
