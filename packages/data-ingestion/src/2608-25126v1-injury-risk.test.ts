/**
 * Tests for ./2608-25126v1-injury-risk (arXiv:2608.25126v1, lane=causal_injury).
 *
 * ACCEPTANCE GATE: ADAPT the four-sub-model + learned-integration architecture now. ADOPT for live availability discounting only if the out-of-sample ARS-missed-games correlation >= 0.25 and the style-exposure penalty improves it over the unpenalized score; otherwise REJECT the live use and keep it as a research prototype.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2608-25126v1-injury-risk";

describe("2608-25126v1 Multimodal Injury Risk Prediction in Tennis", () => {
