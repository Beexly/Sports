/**
 * Tests for ./2602-19513v1-score-model (arXiv:2602.19513v1, lane=win_spread_total).
 *
 * ACCEPTANCE GATE: ADOPT the Brownian closed-form WP if on 2023-2024 its Brier score is <= the nfl4th-grid Brier (within 0.0005) with max decile deviation <0.03; ADOPT the X-index player metric if season X-index has test-retest stability >=0.5 across season halves.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2602-19513v1-score-model";

describe("2602-19513v1 Real-time Win Probability and Latent Player", () => {
