 ...
 *
 * arXiv:2112.01267v1 · lane:team_ratings · verdict:ADAPT · owner:Mimo
 *
 ...
 *
 * Improvement (wiring record): Build a four-bucket margin BT team-strength module on nflverse 2015-2025: outcomes {win by >=14, win
 * 1-13, loss 1-13, loss >=14} with the ordered strength exponents fit as free parameters (prior
 * support p_OW in (1/2,1), season-varying tau for overtime/close-game rates under post-2022 OT rules)
 * instead of fixed 2/3-1/3, Gaussian hierarchical season-to-season prior on lambda_i, explicit HFA
 * term; used for coherent alt-spread/total fair pricing.
 *
 * ACCEPTANCE GATE: Adopt iff the four-bucket model beats standard BT log-loss by >=1.0% and beats the market baseline
 * by >=0.25% on the 2024-2025 rolling window, with bucket coverage within 1.5pp per bucket.
 *
...
export const ARXIV_ID = "2112.01267v1" as const;
export const LANE = "team_ratings" as const;

/** Numeric acceptance gate, verbatim from the wiring record (evaluated offline on backtest data). */
export const ACCEPTANCE_GATE = `Adopt iff the four-bucket model beats standard BT log-loss by >=1.0% and beats the market baseline by >=0.25% on the 2024-2025 rolling window, with bucket coverage within 1.5pp per bucket.`;
