 ...
 *
 * arXiv:2512.04407v1 · lane:team_ratings · verdict:ADAPT · owner:Motif-lab · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * GSE learns stable team archetypes (e.g., rush-heavy, explosive-dropback) from a Bayesian mixture of Gaussian graphical models over team-week metrics, adding archetype indicators as matchup features.
 *
 * ACCEPTANCE GATE:
 * ADOPT archetype features if (a) the MFM posterior puts >=80% mass on a single K in the 2015-2023 fit AND half-season ARI >=0.6, and (b) adding archetype indicators improves walk-forward ATS log-loss on 2024-2025 by >=0.003.
 *
...
export const ARXIV_ID = "2512.04407v1" as const;
...
export const ACCEPTANCE_GATE = `ADOPT archetype features if (a) the MFM posterior puts >=80% mass on a single K in the 2015-2023 fit AND half-season ARI >=0.6, and (b) adding archetype indicators improves walk-forward ATS log-loss on 2024-2025 by >=0.003.`;
