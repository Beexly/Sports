/**
 * Tests for ./1502-05886v1-nlp (arXiv:1502.05886v1, lane=nlp).
 *
 * ACCEPTANCE GATE: ADOPT the sentiment feature iff on the locked 2024 out-of-sample test it achieves AUROC >= 0.60 on
 * upset classification AND the adapted betting rule shows positive marginal profit.
 */
import { describe, expect, it } from "vitest";
import * as mod from "./1502-05886v1-nlp";

describe("NLP text features (arXiv:1502.05886v1)", () => {
  it("tokenizes text", () => {
