/**
 * Tests for ./2411-08901v1-injury-risk (arXiv:2411.08901v1, lane=causal_injury).
 *
 * ACCEPTANCE GATE: ADOPT the window-sweep protocol iff the best grid cell on the 2025 rolling test achieves TPR ≥ 0.30 at precision ≥ 0.30 with chronological splits.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2411-08901v1-injury-risk";

describe("2411-08901v1 SoccerGuard: Injury Prediction Framework", () => {
