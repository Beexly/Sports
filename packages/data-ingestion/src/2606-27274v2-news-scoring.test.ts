/**
 * Tests for ./2606-27274v2-news-scoring (arXiv:2606.27274v2, lane=nlp).
 *
 * ACCEPTANCE GATE: Adopt if macro-F1 ≥ 0.65 on triple-annotated held-out promos with annotator κ ≥ 0.6 AND deceptive-class F1 ≥ 0.60 (the paper's 0.511 is the bar to clear).
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2606-27274v2-news-scoring";

describe("2606-27274v2 BetXplain: An Explanation-Annotated Dataset for Detecting", () => {
