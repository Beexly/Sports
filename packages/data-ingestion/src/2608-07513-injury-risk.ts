 ...
 *
 * arXiv:2608.07513 · lane:causal_injury · verdict:ADAPT · owner:Hermes · doctrine:SITUATIONAL
 *
 ...
 *
 * Improvement (record):
 * Port the strictly-causal SkiC-LSTM architecture to NGS tracking as the event detector feeding GSE's workload features (high-intensity decelerations, cut counts), adopting the paper's leave-one-player-out validation protocol verbatim for all GSE injury and workload models.
 *
 * ACCEPTANCE GATE:
...
export const ARXIV_ID = "2608.07513" as const;
...
export const ACCEPTANCE_GATE = `Accepted: genuine injury-prevention research (ACL), strictly causal real-time architecture with sub-millisecond inference, rigorous LOSO validation explicitly designed against identity bias, open data/code/weights, and two concrete GSE ports (NGS event segmentation for workload features; LOSO validation discipline for injury models).`;
