 ...
 *
 * arXiv:2010.08784 · lane:auto_feature_eng · verdict:ADAPT · owner:Hermes
 *
 ...
 *
 * Improvement (wiring record): Build 'GSE-DIFER' as a second-stage composer on top of the OpenFE base+survivor feature set:
 * numerical time-safe base features only (EPA/play, success rates, pressure/explosive rates, rolling
 * means); parse-tree search space (unary {log, sqrt, minmax, reciprocal, square}, binary {+,-,x,divide
 * zero-guarded}), max order K=3; population init 512 random compositions scored by LightGBM log-loss
 * on expanding-window validation seasons; encoder-predictor-decoder (LSTM-512 + 5-layer MLP) with
 * gradient-ascent feature evolution to 4,096 evaluations and early-stopped top-d selection.
 *
