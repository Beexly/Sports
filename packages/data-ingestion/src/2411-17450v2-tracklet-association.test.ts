/**
 * Tests for ./2411-17450v2-tracklet-association (arXiv:2411.17450v2, lane=tracking).
 *
 * ACCEPTANCE GATE: Adopt the per-frame GNN lane if the scheme-family-specific GNNs beat the pooled GNN by ≥0.02 ROC-AUC on weeks 16–18 AND beat the logistic baseline by ≥0.05 ROC-AUC, with ECE ≤ 0.10 after recalibration.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2411-17450v2-tracklet-association";

describe("2411-17450v2 A Graph Neural Network deep-dive into", () => {
