/**
 * Tests for ./2402-04898v1-props-dfs (arXiv:2402.04898v1, lane=props_dfs).
 *
...
import * as mod from "./2402-04898v1-props-dfs";

describe("props/DFS primitives (arXiv:2402.04898v1)", () => {
  const players = [
