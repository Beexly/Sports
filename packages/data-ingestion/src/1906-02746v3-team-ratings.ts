 ...
 *
 * arXiv:1906.02746v3 · lane:team_ratings · verdict:ADAPT · owner:Hermes
 *
 ...
 *
 * Improvement (wiring record): Publish SVD-NRS spectral power ratings (H from demeaned home/away margins, degree-normalized,
 * zero-mean rhat) alongside Elo as the early-season prior and as a rater-agreement diagnostic, with
 * Kendall correlation between SVD-NRS, Elo, and market-implied ratings flagging games for analyst
 * review.
 *
 * ACCEPTANCE GATE: ADAPT as a permanent ensemble/diagnostic member if it matches Elo within 1% season accuracy and wins
 * or ties weeks 1-4 (sparse-regime value confirmed). If it trails Elo by >1.5% with no early-season
 * edge, REJECT as redundant.
 *
...
export const ARXIV_ID = "1906.02746v3" as const;
export const LANE = "team_ratings" as const;

/** Numeric acceptance gate, verbatim from the wiring record (evaluated offline on backtest data). */
export const ACCEPTANCE_GATE = `ADAPT as a permanent ensemble/diagnostic member if it matches Elo within 1% season accuracy and wins or ties weeks 1-4 (sparse-regime value confirmed). If it trails Elo by >1.5% with no early-season edge, REJECT as redundant.`;
