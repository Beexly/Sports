/**
 * Tests for ./2609-00905v1-tracklet-association (arXiv:2609.00905v1, lane=tracking).
 *
 * ACCEPTANCE GATE: ADAPT (adopt as GSE's slate sampler) if: Pref-MH slates achieve >= 15% higher realized mean score at equal-or-better diversity than i.i.d. p0 draws on walk-forward 2025 weeks, AND the judge passes BT-consistency diagnostics (transitivity >= 95%, vote independence); reject otherwise.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2609-00905v1-tracklet-association";

describe("2609-00905v1 When Metropolis and Hastings Meet Bradley", () => {
