 ...
 *
 * arXiv:1909.10631v3 · lane:tracking · verdict:ADAPT · owner:Hermes
 *
 ...
 *
 * Improvement (wiring record): Apply the precise-distance 4th-down correction everywhere GSE estimates or cites go-for-it value:
 * replace integer distance-to-go with fractional distance from tracking ball coordinates, carrying the
 * ~40% attenuation discount on historical aggressiveness-value claims until recomputed on 2023-2025;
 * adopt the NGS data-handling best-practices into lane docs unconditionally.
 *
...
export const ARXIV_ID = "1909.10631v3" as const;
export const LANE = "tracking" as const;

/** Numeric acceptance gate, verbatim from the wiring record (evaluated offline on backtest data). */
export const ACCEPTANCE_GATE = `Adopt the precise-distance correction into GSE's 4th-down content and models if the reproducible test shows attenuation of >=25% (integer vs. precise) on 2023-2024 data; reject (<10% on modern data) as era-specific. The NGS data-handling reference is adopted unconditionally.`;
