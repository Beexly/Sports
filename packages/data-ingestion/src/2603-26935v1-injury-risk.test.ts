/**
 * Tests for ./2603-26935v1-injury-risk (arXiv:2603.26935v1, lane=causal_injury).
 *
 * ACCEPTANCE GATE: ADOPT the MS-PEM design as GSE's causal check iff the replication reproduces the attenuation pattern (IPW moves naive lag weights ≥ 40% toward zero) on 2020–2024 data with player-grouped CV.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2603-26935v1-injury-risk";

describe("2603-26935v1 Load Management and the Healthy-Worker Survivor", () => {
