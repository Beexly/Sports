 ...
 *
 * arXiv:2512.00203v2 · lane:experimental · verdict:ADAPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * GSE decomposes offensive threat into attempt-generation x conversion: P(deep pass attempt | dropback) and P(success | attempt) from nflverse features, aggregated to a drive-threat metric more stable week-to-week than EPA/play sums.
 *
 * ACCEPTANCE GATE:
 * Adopt if on 2025 held-out weeks the aggregated drive-threat metric beats the EPA/play-sum baseline on MAE with a paired week-level test at p<0.05 AND the attempt-generation component alone shows higher week-to-week stability.
 *
...
export const ARXIV_ID = "2512.00203v2" as const;
...
export const ACCEPTANCE_GATE = `Adopt if on 2025 held-out weeks the aggregated drive-threat metric beats the EPA/play-sum baseline on MAE with a paired week-level test at p<0.05 AND the attempt-generation component alone shows higher week-to-week stability.`;
