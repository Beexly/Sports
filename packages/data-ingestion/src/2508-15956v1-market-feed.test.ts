/**
 * Tests for ./2508-15956v1-market-feed (arXiv:2508.15956v1, lane=markets).
 *
 * ACCEPTANCE GATE: ADAPT if on 2024 holdout: (a) closing-spread MAE <=3.0 points AND beats carry-forward by >=0.75 points, or (b) the anomaly detector flags >=10 verifiable news-driven line moves with precision >=50%; REJECT if neither holds.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2508-15956v1-market-feed";

describe("2508-15956v1 Dynamic Graph-Based Forecasts of Bookmakers' Odds", () => {
