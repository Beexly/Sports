/**
 * Tests for ./2006-11909v2-team-ratings (arXiv:2006.11909v2, lane=team_ratings).
 *
 * ACCEPTANCE GATE: ADOPT as the regime-change gate if Test 1's false-rejection rate is within [2%, 10%] (calibrated)
 * AND Test 3 rejects at p<0.05 (power against a real break); otherwise restrict to multi-season
 * aggregates only.
 */
import { describe, expect, it } from "vitest";
import * as mod from "./2006-11909v2-team-ratings";

describe("team ratings (arXiv:2006.11909v2)", () => {
