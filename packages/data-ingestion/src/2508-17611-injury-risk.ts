 ...
 *
 * arXiv:2508.17611 · lane:causal_injury · verdict:ADAPT · owner:Motif-lab · doctrine:SITUATIONAL
 *
 ...
 *
 * Improvement (record):
 * GSE builds a route-timing causal metric on NGS tracking: detect WR route-break initiations, generate xi-shifted counterfactuals, score with an expected-completion-value surface, and serve per-receiver timing bias (chronically early/late breakers) into prop models.
 *
 * ACCEPTANCE GATE:
 * Accepted: genuine temporal-counterfactual causal method for tracking data with open code; the small single-team sample limits the paper's own conclusions but the NGS application is concrete.
 *
...
export const ARXIV_ID = "2508.17611" as const;
...
export const ACCEPTANCE_GATE = `Accepted: genuine temporal-counterfactual causal method for tracking data with open code; the small single-team sample limits the paper's own conclusions but the NGS application is concrete.`;
