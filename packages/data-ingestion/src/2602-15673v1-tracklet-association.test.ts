/**
 * Tests for ./2602-15673v1-tracklet-association (arXiv:2602.15673v1, lane=tracking).
 *
 * ACCEPTANCE GATE: Adopt if on 2020-2025 weeks-1-8 inputs the simulator's P(playoff) Brier score beats the flat-preseason-Elo baseline by >=5% relative improvement in at least 4 of 6 seasons, with no season worse than baseline.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2602-15673v1-tracklet-association";

describe("2602-15673v1 Leicester's Tale: Another Perspective on the", () => {
