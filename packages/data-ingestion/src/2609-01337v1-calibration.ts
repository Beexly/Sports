 ...
 *
 * arXiv:2609.01337v1 · lane:calibration · verdict:ADAPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
...
export const ARXIV_ID = "2609.01337v1" as const;
...
export const ACCEPTANCE_GATE = `ADOPT if on the 2024-2025 window the posterior achieves Brier improvement >=0.010 over the engine-only forecast AND ECE improves by >=25% relative with no accuracy degradation; REJECT if Brier worsens on the test window or removing the engine prior performs comparably (the LLM evidence adds nothing beyond the prior).`;
