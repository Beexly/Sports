/**
 * Tests for ./2608-10045v1-team-rating (arXiv:2608.10045v1, lane=team_ratings).
 *
 * ACCEPTANCE GATE: ADOPT the reliability-fusion layer if BoRaEM beats plain BT by >=0.002 Brier (or >=0.02 log-loss nat improvement) on the held-out 2025 season AND learned beta_s values are stable across two independent train windows (rank correlation >=0.8), without degrading calibration (ECE change within +-0.005).
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2608-10045v1-team-rating";

describe("2608-10045v1 Finding the Signal in the Spam:", () => {
