 ...
 *
 * arXiv:2608.25126v1 · lane:causal_injury · verdict:ADAPT · owner:Mimo · doctrine:SITUATIONAL
 *
 ...
 *
 * Improvement (record):
 * Build a four-sub-model availability-discount module (wellness, injury risk, physical capability, style/exposure sub-models on public proxies, integrated via MLR against a next-4-week games-missed proxy label) with a calibrated style-exposure penalty multiplier, feeding GSE's fantasy/prop projections and live availability discounting.
 *
 * ACCEPTANCE GATE:
...
export const ARXIV_ID = "2608.25126v1" as const;
...
export const ACCEPTANCE_GATE = `ADAPT the four-sub-model + learned-integration architecture now. ADOPT for live availability discounting only if the out-of-sample ARS-missed-games correlation >= 0.25 and the style-exposure penalty improves it over the unpenalized score; otherwise REJECT the live use and keep it as a research prototype.`;
