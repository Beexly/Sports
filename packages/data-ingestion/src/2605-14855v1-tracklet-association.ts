 ...
 *
 * arXiv:2605.14855v1 · lane:tracking · verdict:ADAPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * Adopt the CNN-LSTM context architecture (kernel adapted to football's frame rate; static landmarks = goal line, end zones, first-down line) for ball-carrier + nearest-defender 2s trajectory forecasting from NGS tracking, sweeping input lengths 0.5-4.0s.
 *
 * ACCEPTANCE GATE:
 * ADOPT the CNN-LSTM context architecture if, on the held-out weeks 15–18 test set, it beats the constant-velocity baseline by ≥15% FDE AND beats the plain 2-layer LSTM by ≥5% FDE at the 2.0s horizon.
 *
...
export const ARXIV_ID = "2605.14855v1" as const;
...
export const ACCEPTANCE_GATE = `ADOPT the CNN-LSTM context architecture if, on the held-out weeks 15–18 test set, it beats the constant-velocity baseline by ≥15% FDE AND beats the plain 2-layer LSTM by ≥5% FDE at the 2.0s horizon.`;
