 ...
 *
 * arXiv:2603.14629v1 · lane:data_infra · verdict:ADAPT · owner:Hermes · doctrine:INFRA
 *
 ...
 *
 * Improvement (record):
 * GSE rebuilds its research pipeline on full-text extraction (method, equations, datasets, results, limitations) into persisted 14-section ledgers with prior-extraction surfacing, replacing the abstract-only design that duplicates research.
 *
 * ACCEPTANCE GATE:
 * ADAPT the architecture, REJECT the abstract-only design. Adopt if the repo runs locally, full-text extraction achieves 100% section/table pointer coverage on a 5-paper pilot, and the persisted corpus demonstrably prevents duplicate research; unverified drafts stay internal until hand-verified.
 *
...
export const ARXIV_ID = "2603.14629v1" as const;
