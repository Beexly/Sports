...
export const SOURCE_REGISTRY: Readonly<Record<string, LegalSource>> = {
  ...
  moneypuck: {
    ...
    provider: "MoneyPuck",
    kind: "bulk-open-data",
    license: { spdx: null, name: "MoneyPuck (free download, credit requested)", url: "https://moneypuck.com/data.htm" },
    commercialUse: true,
    attributionRequired: true,
    ...
    verdict: "cleared-with-attribution",
    reason: "Free NHL shot-level + xG/win-probability CSVs back to 2008; credit MoneyPuck.",
