 ...
 *
 * arXiv:2506.22450v1 · lane:mixed · verdict:ADAPT · owner:Mimo · doctrine:SITUATIONAL
 *
 ...
 *
 * Improvement (record):
 * GSE generates probabilistic game-day weather from the Pangu Weather 24h model perturbed by Arnoldi singular vectors (K~16 members, zero-mean pairs), extracting a stadium ensemble distribution rather than a point forecast.
 *
 * ACCEPTANCE GATE:
 * ADAPT if ensemble spread shows positive spread-skill correlation on hold-out games and tail-wind detection beats the deterministic baseline on totals residuals; otherwise keep only deterministic Pangu.
 *
...
export const ARXIV_ID = "2506.22450v1" as const;
...
export const ACCEPTANCE_GATE = `ADAPT if ensemble spread shows positive spread-skill correlation on hold-out games and tail-wind detection beats the deterministic baseline on totals residuals; otherwise keep only deterministic Pangu.`;
