/**
 * Tests for ./2509-01243v1-score-model (arXiv:2509.01243v1, lane=win_spread_total).
 *
 * ACCEPTANCE GATE: ADOPT if CUSUM flow features improve the game-model log-loss >=0.002 on the 2022-2024 holdout or the chi-square test shows >=2pp conditional-probability effects.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2509-01243v1-score-model";

describe("2509-01243v1 A novel methodological framework for analyzing", () => {
