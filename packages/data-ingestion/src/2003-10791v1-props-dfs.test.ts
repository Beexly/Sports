/**
 * Tests for ./2003-10791v1-props-dfs (arXiv:2003.10791v1, lane=props_dfs).
 *
...
import * as mod from "./2003-10791v1-props-dfs";

describe("props/DFS primitives (arXiv:2003.10791v1)", () => {
  const players = [
