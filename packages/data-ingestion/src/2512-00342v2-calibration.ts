 ...
 *
 * arXiv:2512.00342v2 · lane:calibration · verdict:ADAPT · owner:Hermes · doctrine:PROPRIETARY_EDGE
 *
 ...
 *
 * Improvement (record):
 * GSE adds an online meta layer over the frozen weekly engine: N=8-16 candidate drift models (linear probes on recent-form residuals, injury-adjusted roster deltas, market-move direction) reweighted weekly on the season's own outcomes.
 *
 * ACCEPTANCE GATE:
 * Adopt the meta layer if over the 2022-2025 walk-forward the meta-weighted forecast beats the frozen offline baseline by >=0.005 Brier (win prob) or >=0.15 points MAE vs close (spread/total), improvement concentrated in weeks 6-18, with no catastrophic weekly degradation.
 *
...
export const ARXIV_ID = "2512.00342v2" as const;
...
export const ACCEPTANCE_GATE = `Adopt the meta layer if over the 2022-2025 walk-forward the meta-weighted forecast beats the frozen offline baseline by >=0.005 Brier (win prob) or >=0.15 points MAE vs close (spread/total), improvement concentrated in weeks 6-18, with no catastrophic weekly degradation.`;
