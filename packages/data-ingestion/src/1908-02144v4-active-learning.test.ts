/**
 * Tests for ./1908-02144v4-active-learning (arXiv:1908.02144v4, lane=active_learning).
 *
...
import * as mod from "./1908-02144v4-active-learning";

describe("info-per-cost active learning (arXiv:1908.02144v4)", () => {
