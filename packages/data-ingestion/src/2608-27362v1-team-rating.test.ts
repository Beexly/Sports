/**
 * Tests for ./2608-27362v1-team-rating (arXiv:2608.27362v1, lane=team_ratings).
 *
 * ACCEPTANCE GATE: Accept the module if on 2000-2025 NFL: (i) out-of-sample (even seasons) Brier <= static BT/Elo baseline after Platt calibration; (ii) calibration slope within [0.9, 1.1] post-fit; (iii) component correlation rho-hat significantly > 0 by prequential likelihood; reject the dynamical component if tau-hat is unidentified or the iterated filter underperforms single-step on simulated recovery.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2608-27362v1-team-rating";

describe("2608-27362v1 How Exceptional Was the Big Three", () => {
