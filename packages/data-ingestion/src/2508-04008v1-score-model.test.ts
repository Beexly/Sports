/**
 * Tests for ./2508-04008v1-score-model (arXiv:2508.04008v1, lane=win_spread_total).
 *
 * ACCEPTANCE GATE: ADOPT if adjusted stats correlate >=0.03 better with season point differential than raw stats AND beat raw stats in LOSOCV margin forecasting at p<0.05.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2508-04008v1-score-model";

describe("2508-04008v1 Leveraging Minute-by-Minute Soccer Match Event Data", () => {
