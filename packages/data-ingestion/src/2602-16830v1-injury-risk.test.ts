/**
 * Tests for ./2602-16830v1-injury-risk (arXiv:2602.16830v1, lane=causal_injury).
 *
 * ACCEPTANCE GATE: ADAPT the DML harness if the placebo test passes (|beta_hat_placebo| < 0.2*|beta_hat_real|) AND estimates are stable across two nuisance learners with sign agreement on all significant effects.
 */

import { describe, expect, it } from "vitest";
import * as mod from "./2602-16830v1-injury-risk";

describe("2602-16830v1 The Impact of Formations on Football", () => {
