...
| Stale Line Risk Score | complete for governed shadow metric | `packages/prediction-engine/src/metrics/market/stale-line-risk-score.ts`, `packages/prediction-engine/src/metrics/__tests__/stale-line-risk-score.test.ts`, metric birth certificate/export updates, `docs/math/GSE_PROPRIETARY_METRIC_BIBLE.md` | QB Burden Index, then model/drift-card coverage before any promotion |
| QB Burden Index | complete for governed shadow metric | `packages/prediction-engine/src/metrics/passing/qb-burden-index.ts`, `packages/prediction-engine/src/metrics/__tests__/qb-burden-index.test.ts`, metric birth certificate/export updates, `docs/math/GSE_PROPRIETARY_METRIC_BIBLE.md` | Playable Window Score and model/drift-card coverage before any promotion |
| Role Volatility Index | complete for governed shadow metric | `packages/prediction-engine/src/metrics/role/role-volatility-index.ts`, `packages/prediction-engine/src/metrics/__tests__/role-volatility-index.test.ts`, metric birth certificate/export updates, `docs/math/GSE_PROPRIETARY_METRIC_BIBLE.md` | Playable Window Score and model/drift-card coverage before any promotion |
...
- Next overall gate: owner-reviewed API route design remains blocked; next safe local work is Playable Window Score or model/drift-card coverage, then owner-reviewed production preview QA before any live push.
