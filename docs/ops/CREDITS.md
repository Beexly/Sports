...
| Cerebras free | https://cloud.cerebras.ai | Free lane content | | CEREBRAS_API_KEY + CONTENT_FREE_LANE_ENABLED |
| Groq free | https://console.groq.com | Internal LLM tier | | INTERNAL_LLM_* |

Full sequencing + traps: [`GSE_CREDITS_PROGRAMS_ACTION_PACK_V3.md`](./GSE_CREDITS_PROGRAMS_ACTION_PACK_V3.md)
