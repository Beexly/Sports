...
| 11 | The Odds API credit governor so the 20K plan lasts the month (section 3f) | DONE 2026-09-06 04:55 UTC (`3359e072a`, C-109) | the plan survives to the credit reset with no exhaustion; average burn over the period at or below 645 a day; the hourly reserve mode engages automatically; `oddsInserting.dualPath.credits` on the truth surface |
