...
- `packages/prediction-engine/src/metrics/__tests__/metric-evidence-cards.test.ts`
  - proves SLRS, QBI, RVI, CIG, PWS, PFS, and MMS fixture-generated cards remain draft-first, preserve `SHADOW` lifecycle and API/licensing locks, carry caveats, and keep role, calibration, decision, portfolio, and market fixtures in drift review
...
- `docs/math/GSE_SHADOW_METRIC_EVIDENCE_REPORTS.md`
  - repo-visible report for SLRS, QBI, RVI, PWS, and MMS
