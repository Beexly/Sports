...
- When WR1/WR2 injuries sidelines a starter, the slot receiver's target share jumps from **12-15% to 22-26%** for 3-5 weeks
...
**Teams with Significant TE/WR Rotation Changes (2026 Preseason):**
...
**Key Snap Count Discrepancies to Exploit:**
...
**Example from data:** Jaylen Warren had 120 carries but only 49% snaps vs. Najee Harris's 263 carries at 49% snaps. Harris is the goal-line/early-down back — bet his rushing yard OVER.
...
**Example:** Rachaad White had higher snap % than Irving but fewer carries. White handled pass protection and receiving downs.
...
- **Proxy:** Target share in passing situations (available via Next Gen Stats)
- **Edge:** This RB's receptions prop has higher floor than rushing yards for the same-backfield companion
...
|---|---|---|---|---|
| **Lions** | Jahmyr Gibbs | Isiah Pacheco | 70/30 (projected) | Gibbs OVER; Pacheco UNDER except goal-line |
| **Bucs** | Bucky Irving | Kenny Gainwell | 65/35 (projected) | Irving OVER carries; Gainwell OVER receptions |
| **Steelers** | Najee Harris | Jaylen Warren | 55/45 | Harris goal-line OVER; Warren receiving OVER |
| **Raiders** | Alexander Mattison | Zeke | 50/50 (projected) | Avoid; high variance |
| **Cowboys** | Javonte Williams | Jaydon Blue | 75/25 (projected) | Williams OVER; volatility on backup |
| **Packers** | Josh Jacobs | MarShawn Lloyd | 70/30 (projected) | Jacobs OVER; Lloyd only value with injury |
...
| **Commanders** | Brian Robinson | Austin Ecklar | 50/50 | Pure committee — avoid OVERs on yardage |
...
### Sources to Bookmark
- **SumerSports.com** → Teams → Offensive → Personnel Tendency (free, real-time)
- **ProFootballReference.com** → Weekly → Snap Logs (free historical)
- **FantasyPros.com** → Reports → Snap Count Analysis (free tier)
- **PFF.com/betting/player-props** → Cover probability model (PFF+ subscription)
- **Rotowire.com** → Football → Snap Counts (subscription for full player data)
- **NFLPlayerSnaps on X** → Real-time snap count tweets during games

---

## METHODOLOGY NOTES

**Personnel Notation System:**
- First digit = number of RBs on field
- Second digit = number of TEs on field
- Remainder = WRs (5 - RB - TE)
- Example: 11 = 1 RB, 1 TE, 3 WR; 12 = 1 RB, 2 TE, 2 WR; 21 = 2 RB, 1 TE, 2 WR

**Snap Share Calculation:**
Snap Share = (Player Snaps / Team Total Offensive Snaps) × 100

**Important Caveats:**
- Single-game snap spikes can be misleading (injuries, blowouts, special teams)
- Always cross-reference snap counts with target/carry data for true role assessment
