...
|---|---|---|---|---|---|
| C7 | 2026-05-28 | Security gap | Verify repo visibility is `private`; confirm no proprietary methodology in public bundles | B | OPEN |
...
| C7 | 2026-05-28 | Galaxy Constitution + ops/scoring/design docs + Product Kernel scaffold | _pending_ |
