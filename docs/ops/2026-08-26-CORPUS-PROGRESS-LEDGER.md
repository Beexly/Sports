...
| 3 | FL-GUARD negative-update guard | 2403.04146 | `calibration-monitor.ts` | ⏳ QUEUED — next up. Per-cohort gain surrogate, median-across-cohorts, rolling rollback trigger for the C6 apply/rollback decision |
| 4 | Plasticity–Stability regression guard | 2503.04638 | re-fit cadence (~250-settled) | ⏳ QUEUED — bounds recent-cohort gains bought at early-cohort forgetting |
| 5 | Phase-bucketed ECE audit (in-game soccer) | 1906.05029 | `calibration-monitor.ts` | ⏳ QUEUED — H1/H2/final-10% split |
