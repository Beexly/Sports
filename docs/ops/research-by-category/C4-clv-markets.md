...
- `2108.02419` (score 13) Implementing the BBE Agent-Based Model of a Sports-Betting E — Run GSE's prediction engine against synthetic BBE market data to stress-test calibration and CLV performance in scenarios (e.g., new sports) where real settled- 
...
| `2505.06828` | 6 | An Improved Algorithm for a Bipartite Traveling Tournament ti | No strong direct application, but the scheduling-optimization angle could inform a future B2B feature offering optimized fantasy-league or betting-market schedu |
