# VOICE-BUILD-039: Voice abuse and quota throttle
...
Rate-limit generation by surface/tier/user.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-039: Voice abuse and quota throttle. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
