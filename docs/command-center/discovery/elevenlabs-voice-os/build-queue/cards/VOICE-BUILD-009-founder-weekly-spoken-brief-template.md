# VOICE-BUILD-009: Founder weekly spoken brief template
...
Internal launch/revenue/source-health digest script.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-009: Founder weekly spoken brief template. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
