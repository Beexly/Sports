# VOICE-BUILD-006: Voice script safety linter
...
Block hype, impersonation, method leakage, stale-data certainty.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-006: Voice script safety linter. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
