# VOICE-BUILD-031: ElevenLabs UI pattern spike
...
Study component patterns without importing dependency.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-031: ElevenLabs UI pattern spike. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
