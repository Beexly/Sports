# VOICE-BUILD-005: VoiceScript data contract
...
Type scripts before audio assets exist.

## Repo(s) Used

elevenlabs-js, examples

## GSE Surface

packages/types or docs spec
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-005: VoiceScript data contract. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
