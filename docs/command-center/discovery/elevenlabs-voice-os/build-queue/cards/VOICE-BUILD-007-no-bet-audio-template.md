# VOICE-BUILD-007: No-bet audio template
...
Make no-bet value understandable without gambling urgency.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-007: No-bet audio template. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
