# VOICE-BUILD-030: Opus audio encoding research note
...
Evaluate if Opus tooling belongs in backend processing.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-030: Opus audio encoding research note. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
