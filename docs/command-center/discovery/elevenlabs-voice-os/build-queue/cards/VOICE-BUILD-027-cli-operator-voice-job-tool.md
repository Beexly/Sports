# VOICE-BUILD-027: CLI operator voice job tool
...
Design safe local command wrapper that never logs secrets.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-027: CLI operator voice job tool. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
