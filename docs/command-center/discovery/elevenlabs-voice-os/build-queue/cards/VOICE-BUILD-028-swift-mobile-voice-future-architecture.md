# VOICE-BUILD-028: Swift mobile voice future architecture
...
Plan native audio brief and alert experiences.

## Repo(s) Used

elevenlabs-swift-sdk, voice-starterkit-swift, components-swift
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-028: Swift mobile voice future architecture. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
