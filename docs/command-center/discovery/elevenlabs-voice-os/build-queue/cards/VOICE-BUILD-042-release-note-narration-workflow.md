# VOICE-BUILD-042: Release note narration workflow
...
Make changes easy to understand without reading changelog walls.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-042: Release note narration workflow. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
