# VOICE-BUILD-023: Article-to-audio pipeline spec
...
Turn approved articles into audio with citations preserved.

## Repo(s) Used

examples, captions.events
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-023: Article-to-audio pipeline spec. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
