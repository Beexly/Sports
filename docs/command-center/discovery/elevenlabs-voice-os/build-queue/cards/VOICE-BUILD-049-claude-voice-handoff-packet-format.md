# VOICE-BUILD-049: Claude voice handoff packet format
...
Make Claude/Codex voice tasks safe and bounded.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-049: Claude voice handoff packet format. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
