# VOICE-BUILD-004: Local fake voice provider adapter
...
Add no-API provider interface with fake local output for tests.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-004: Local fake voice provider adapter. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
