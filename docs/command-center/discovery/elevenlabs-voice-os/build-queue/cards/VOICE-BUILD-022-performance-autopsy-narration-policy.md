# VOICE-BUILD-022: Performance/autopsy narration policy
...
Narrate outcome reviews without implying future guarantees.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-022: Performance/autopsy narration policy. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
