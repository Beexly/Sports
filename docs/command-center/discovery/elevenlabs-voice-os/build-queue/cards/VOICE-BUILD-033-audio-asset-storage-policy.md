# VOICE-BUILD-033: Audio asset storage policy
...
Define where generated audio/captions live and retention rules.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-033: Audio asset storage policy. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
