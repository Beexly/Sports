# VOICE-BUILD-001: Voice OS repo verification ledger
...
Validate every target repo before adoption.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-001: Voice OS repo verification ledger. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
