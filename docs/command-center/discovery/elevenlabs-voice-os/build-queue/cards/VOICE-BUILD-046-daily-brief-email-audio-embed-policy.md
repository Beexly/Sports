# VOICE-BUILD-046: Daily Brief email audio embed policy
...
Define safe links/embeds and fallback transcript.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-046: Daily Brief email audio embed policy. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
