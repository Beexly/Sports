# VOICE-BUILD-038: Voice cache and regeneration rules
...
Prevent duplicate paid generation and stale assets.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-038: Voice cache and regeneration rules. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
