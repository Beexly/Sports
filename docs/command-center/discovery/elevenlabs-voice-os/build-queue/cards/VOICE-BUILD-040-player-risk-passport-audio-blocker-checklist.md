# VOICE-BUILD-040: Player Risk Passport audio blocker checklist
...
Define roster freshness and data gates before player audio.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-040: Player Risk Passport audio blocker checklist. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
