# VOICE-BUILD-029: Flutter mobile voice future architecture
...
Plan Flutter fallback if mobile stack goes cross-platform.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-029: Flutter mobile voice future architecture. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
