# VOICE-BUILD-026: n8n support audio workflow
...
Automate approved support audio generation after human review.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-026: n8n support audio workflow. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
