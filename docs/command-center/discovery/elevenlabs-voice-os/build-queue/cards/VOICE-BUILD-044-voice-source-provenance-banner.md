# VOICE-BUILD-044: Voice source provenance banner
...
Show what text/source generated each audio asset.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-044: Voice source provenance banner. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
