# VOICE-BUILD-011: Captions event schema
...
Prepare synced captions and transcript timing.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-011: Captions event schema. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
