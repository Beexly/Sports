# VOICE-BUILD-014: Voice cost ledger spec
...
Track characters, minutes, model, cache hits, and budget alerts.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-014: Voice cost ledger spec. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
