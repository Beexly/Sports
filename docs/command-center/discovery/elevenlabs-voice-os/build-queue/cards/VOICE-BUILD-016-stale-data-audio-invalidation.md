# VOICE-BUILD-016: Stale-data audio invalidation
...
Invalidate audio when source text/data changes.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-016: Stale-data audio invalidation. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
