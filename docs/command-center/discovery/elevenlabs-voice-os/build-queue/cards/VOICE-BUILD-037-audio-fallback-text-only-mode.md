# VOICE-BUILD-037: Audio fallback text-only mode
...
Ensure no audio feature blocks comprehension or accessibility.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-037: Audio fallback text-only mode. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
