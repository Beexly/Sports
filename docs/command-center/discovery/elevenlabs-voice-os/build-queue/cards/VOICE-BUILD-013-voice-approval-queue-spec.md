# VOICE-BUILD-013: Voice approval queue spec
...
Require human/founder approval before any public audio.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-013: Voice approval queue spec. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
