# VOICE-BUILD-020: Onboarding voice tour outline
...
Teach users how to find value in 10 seconds.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-020: Onboarding voice tour outline. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
