# VOICE-BUILD-017: Method-leakage audio guard
...
Block formulas, weights, and private methodology from scripts.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-017: Method-leakage audio guard. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
