# VOICE-BUILD-025: MCP script-to-audio workflow design
...
Map approved script generation to controlled audio generation.

## Repo(s) Used

elevenlabs-mcp, elevenlabs-mcp-player
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-025: MCP script-to-audio workflow design. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
