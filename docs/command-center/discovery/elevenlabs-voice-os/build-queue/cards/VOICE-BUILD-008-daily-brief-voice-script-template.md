# VOICE-BUILD-008: Daily Brief voice script template
...
Generate approved text-only audio scripts from daily brief data.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-008: Daily Brief voice script template. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
