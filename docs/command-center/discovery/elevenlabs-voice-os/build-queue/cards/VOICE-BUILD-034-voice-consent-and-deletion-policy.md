# VOICE-BUILD-034: Voice consent and deletion policy
...
Block user audio/transcript storage without consent.
...
You are Claude/Codex working in the GSE repo. Implement only VOICE-BUILD-034: Voice consent and deletion policy. Keep it prototype-safe, do not call paid APIs, do not add secrets, do not deploy, and preserve P0 launch blocker isolation. Add tests or docs proving the safety boundary.
