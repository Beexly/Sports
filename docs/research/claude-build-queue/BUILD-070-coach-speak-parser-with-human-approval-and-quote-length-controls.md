# BUILD-070 - Coach speak parser with human approval and quote length controls
...
Build a focused, source-provenanced implementation path for coach speak parser with human approval and quote length controls without changing production behavior until a separate implementation approval exists.
