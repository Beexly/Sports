# BUILD-104 - GDELT media pressure index
...
Build a focused, source-provenanced implementation path for gdelt media pressure index without changing production behavior until a separate implementation approval exists.
