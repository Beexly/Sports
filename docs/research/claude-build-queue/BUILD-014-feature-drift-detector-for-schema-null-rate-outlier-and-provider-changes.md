# BUILD-014 - Feature drift detector for schema null rate outlier and provider changes
...
Build a focused, source-provenanced implementation path for feature drift detector for schema null rate outlier and provider changes without changing production behavior until a separate implementation approval exists.
