# BUILD-078 - Franchise mode roster projection simulator
...
Build a focused, source-provenanced implementation path for franchise mode roster projection simulator without changing production behavior until a separate implementation approval exists.
