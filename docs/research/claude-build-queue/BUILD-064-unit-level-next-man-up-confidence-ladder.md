# BUILD-064 - Unit-level next man up confidence ladder
...
Build a focused, source-provenanced implementation path for unit-level next man up confidence ladder without changing production behavior until a separate implementation approval exists.
