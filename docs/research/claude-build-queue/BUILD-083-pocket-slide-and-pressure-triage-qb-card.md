# BUILD-083 - Pocket slide and pressure triage QB card
...
Build a focused, source-provenanced implementation path for pocket slide and pressure triage qb card without changing production behavior until a separate implementation approval exists.
