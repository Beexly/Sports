# Risk, legal, and source-policy reviewer

## Assignment

Risk, legal, and source-policy reviewer for the GSE / GSN NFL world-model R&D swarm.

## Output

Flagged NFL/ESPN/media/sportsbook/social/video/injury data as approval-gated before monetized or automated use.
