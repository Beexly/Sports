# Claude Code build-queue author

## Assignment

Claude Code build-queue author for the GSE / GSN NFL world-model R&D swarm.

## Output

Generated 120 implementation cards with priorities, dependencies, source families, risk notes, and expected repo touchpoints.
