 ...
 *
 * Settlement is delegated to settlePicks() from @sports/ingestion-pipeline,
 * which covers both The Odds API scores (primary) and TheSportsDB (fallback for
 * games that slip past the 3-day Odds API window).
 *
...
async function main(): Promise<void> {
  ...
  await settlePicks(apiKey, 3, "[data-refresh:settle]");
