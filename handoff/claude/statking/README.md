# Galaxy StatKing Claude Handoff

Package location: `/handoff/claude/statking/`

Open first: `START_HERE.md`, then `CLAUDE_NEXT_PROMPT.md`, then `ROUTE_MAP.md`.

Recommended first Claude prompt: copy `CLAUDE_NEXT_PROMPT.md`.

Important warnings: preserve rights gates, fixture labels, source lineage, data status badges, and merge-readiness honesty. Do not imply unavailable data is active.
...
Merge recommendation: preserve/merge as a StatKing foundation and Claude UX branch only after accepting the repo-wide typecheck caveat; do not market as complete “King of Stats” yet.
