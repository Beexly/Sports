...
| #92 | claude/hotfix-settle-refresh-races | main | M-F6: refresh rewrite atomic (updateMany where result:PENDING; P2002 winner adoption) — settle race can't corrupt a graded pick. M-F7: MAX_CLOSE_AGE_MS 6h close bound (never invent a close) + take 80→240 batch cap. NOTE: touches settle-sport.ts like #84/#86 — last to land takes small rebase |
