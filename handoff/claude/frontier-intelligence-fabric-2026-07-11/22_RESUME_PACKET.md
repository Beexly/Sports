...
| #95 | claude/hotfix-vacuous-stub-tests | main | O-6: 8 populated-fixture pins for board state/passes + daily-slate (suppression proven against DATA, zero-query short-circuit pinned; where-clause/mapping/aggregation no longer vacuously green). Test-only, zero runtime diff |
