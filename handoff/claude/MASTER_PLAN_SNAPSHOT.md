...
| AI | LiteLLM + free Gemini/Groq volume + Grok/Claude reason |
...
| CODE_READY | Hydration stubs · Phase C harness (unverified) · LiteLLM stand-up (needs keys) · context packs / durable receipts (needs Neon) |
...
|---------|------------------------|-------|
| Microsoft Founders Hub | ~$1k Azure **without investor code** → entity verify → higher path (~$150k) | Optional Foundry via LiteLLM; not SoT |
...
| AWS Activate Founders | ~$1k–$5k self-funded | Secondary / Bedrock via LiteLLM |
...
| Concern | Decision |
|---------|----------|
| Proxy | LiteLLM; Admin UI = spend SoT |
...
| Cloud AI | Azure Foundry / Vertex / Bedrock **only via LiteLLM** |
...
- Direct Azure/Bedrock SDKs (LiteLLM only)  
...
| Sitting 2 (30–60 min) | Gemini + Groq + xAI keys into Vercel | Keys present; one LiteLLM or internal call works |
