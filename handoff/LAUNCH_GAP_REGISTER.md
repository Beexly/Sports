...
G-4 | data | HIGH | TPR + separation harnesses starved: NGS receiving lacks `routes`; pbp_participation not ingested (R34/R36 verdicts) | BLOCKED@<no-commit-needed> - exact URLs 404 (pbp_participation.csv.gz, pbp_participation_weekly.csv.gz); no routes verified; no JSON produced | hermes/h2-remaining-binds
