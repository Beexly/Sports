...
- URL verification needed before reuse: @MagicSportsGuy RB Rush Share X status URL (digit-sequence discrepancy in pass report); @statyxio Throw Distribution X status URL (trailing digits looked transposed).
