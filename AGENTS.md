...
3. **NEVER flip a gate or env flag** — `PUBLIC_PICKS`, `STATS_PUBLIC`, `LIVE_BOARD`,
   ...
   **Owner amendment, 2026-09-09 (founder, verbatim: "if we need to remove this then do
   ...
   is recorded as a ledger row citing this amendment. C-290 (the bias-corrected ECE,
   `docs/ops/CALIBRATION_ECE_ESTIMATOR_2026-09-09.md`) is the first and only such change.
