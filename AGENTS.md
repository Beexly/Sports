...
2. **Both named structural upgrades pass pre-registered out-of-sample kill lines (2025 W1-8 fit, W9-18 test, n=151 games; scripts in the artifacts dir).** Opponent-adjusted EPA: RMSE 13.322 vs 13.597 raw, Spearman 0.393 vs 0.323 raw; the market spread remains clearly ahead (RMSE 12.245, Spearman 0.490, Brier 0.220), consistent with standing doctrine that the market is the anchor, not the enemy. Fitted conversion on full 2025 is ~45.4 points per EPA/play net diff with ~2.1 points effective home field, against repo constants scale 0.12 / HFA 0.025 EPA (~1.1 points): a founder-gated scoring check for the next MODEL_VERSION bump, not an edit. Turnover occurrence-vs-recovery: expected turnover differential (shrunk occurrence rates, recovery at 50 percent) predicts W9-18 actuals at Spearman 0.375 vs 0.219 for naive persistence, and recovery-share persistence reads 0.151 on 32 teams, consistent with luck. This is the measured basis for wiring occurrence-based expected turnovers as a v5.3.0 factor input.
