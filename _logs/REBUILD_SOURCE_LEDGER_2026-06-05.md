...
- Aborted this session (recon friction, queued): MLB via Lahman/baseballdatabank (GitHub path 404'd + api.github.com blocked in this env — need correct raw path/branch); CFBD (needs a free API key → gated).
