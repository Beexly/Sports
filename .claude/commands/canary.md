...
1. Run `npm run smoke:prod` (`scripts/post-deploy-smoke.mjs`). Read its exit code and output: exit 1 = FAIL; exit 0 with "warning(s)" in the summary line = WATCH; exit 0 with "all green" = SHIP.
